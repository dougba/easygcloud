...
CTFrontendBuilder.controller("ControllerConditions",["$scope","$parentScope","$timeout",function(s,t,o){s.getGlobalConditions=function(){var o=s.component.active.id;return s.component.options[o].model.globalconditions||!1},s.setGlobalConditions=function(o){o=atob(o);try{var n=JSON.parse(o)}catch(o){return!1}if(!n.conditions)return!1;if(!n.hash)return!1;var i=s.stringToHash(JSON.stringify(n.conditions));return n.hash===i&&(s.setOptionModel("globalconditions",n.conditions),s.setOptionModel("conditionstype",n.conditionstype),s.setOptionModel("conditionspreview",n.inEditorBehavior),t.evalGlobalConditions(),!0)},s.copyConditions=function(){var o={conditions:s.getGlobalConditions(),inEditorBehavior:s.getOption("conditionspreview"),conditionstype:s.getOption("conditionstype"),hash:s.stringToHash(JSON.stringify(s.getGlobalConditions()))},n=JSON.stringify(o);n=btoa(n),s.copyToClipboard(n),s.showNoticeModal("<div>Element Conditions copied to clipboard!</div>","ct-notice")},s.pasteConditions=function(o){o&&(s.setGlobalConditions(o)?s.showNoticeModal("<div>Element Conditions applied from your code!</div>","ct-notice"):(s.showNoticeModal("<div>Element Conditions NOT applied. Code parsing issue.</div>"),console.log(o)))},s.getGlobalCondition=function(o){var n=s.component.active.id;return null!=s.component.options[n].model.globalconditions&&null!=s.component.options[n].model.globalconditions[o]&&null!=s.component.options[n].model.globalconditions[o].name&&s.globalConditions[s.component.options[n].model.globalconditions[o].name]},s.getConditionValue=function(o,n){var i=s.getGlobalCondition(o);return null==i||null==i.values?"":i.values.keys&&i.values.options[n.value]?i.values.options[n.value]:n.value},s.getConditionPlaceholder=function(o){var n=s.getGlobalCondition(o);return null==n||null==n.values?"Custom Value...":n.values.placeholder?n.values.placeholder:"Custom Value..."},s.isCustomCondition=function(o){var n=s.getGlobalCondition(o);return null!=n&&null!=n.values&&n.values.custom},s.isAJAXCondition=function(o){var n=s.getGlobalCondition(o);return null!=n&&null!=n.values&&n.values.ajax},s.updateConditionOptions=function(o,n,i){if(null!=o&&null!=n){if(""!==i){var t=!1;for(var e in n)if(n.hasOwnProperty(e)&&n[e]==i){s.setConditionValue(o,e,i),t=!0;break}t||s.setConditionValue(o,-1,i)}var l=s.getGlobalCondition(o);null!=l?l.values.options=n:console.log("No global condition found with index: "+o)}},s.getConditionName=function(o){var n=s.component.active.id;return s.component.options[n].model.globalconditions&&s.component.options[n].model.globalconditions[o]&&s.component.options[n].model.globalconditions[o].name?s.component.options[n].model.globalconditions[o].name:""},s.isKeysCondition=function(o){var n=s.getConditionName(o);return!!(s.globalConditions[n]&&s.globalConditions[n].values&&s.globalConditions[n].values.keys)},s.setConditionValue=function(o,n,i){var t=s.component.active.id;s.isKeysCondition(o)&&void 0!==n?s.component.options[t].model.globalconditions[o].value=n:s.component.options[t].model.globalconditions[o].value=i,s.component.options[t].model.globalconditions[o].searchValue=i,s.setOptionModel("globalconditions",s.component.options[t].model.globalconditions)}}]);
...
CTFrontendBuilder.controller("ControllerCSS",["$scope","$parentScope","$http","$timeout",function(ot,s,e,t){var o,n;ot.idStylesContainer=document.getElementById("ct-id-styles"),ot.classStylesContainer=document.getElementById("ct-class-styles"),ot.customSelectorsExample={"#my-custom-id":{original:{color:"red","font-size":"24px"}}},ot.selectedCSSFolder=null,ot.expandedFolder=[],ot.expandedSelectorFolder=[],ot.expandedStylesets=[],ot.selectedSelectorFolder=null,ot.selectedNodeType=null,ot.selectedStyleSet=null,ot.selectorDetector={mode:!1},ot.cssFolderMenuOpen=!1,ot.selectorFolderMenuOpen=!1,ot.componentSelector={},ot.selectorToEdit=!1,ot.selectorHighlighted=!0,ot.expandedStyleSets=[],ot.APIElementsDefaultCSS=[],ot.excludeProperties=["ct_content","ct_id","ct_parent","tag","url","src","alt","target","icon-id","section-width","custom-width","header-width","header-custom-width","header-row-width","header-row-custom-width","container-padding-top","container-padding-right","container-padding-bottom","container-padding-left","background-position-top","background-position-left","background-size-width","background-size-height","video-padding-bottom","use-custom","custom-code","embed-src","button-style","button-size","button-color","button-text-color","gradient","background","overlay-color","icon-size","icon-style","icon-color","icon-background-color","use-acf-repeater","acf-repeater","background-imagedynamic","srcdynamic","urldynamic","globalConditionsResult","conditionspreview","conditionstype","custom-js","border-all-width","border-all-style","border-all-color","function_name","full_shortcode","gutter","code-css","code-php","code-js","class_name","id_base","pretty_name","friendly_name","separator","date_format","size","meta_key","hover_color","flex-reverse","stack-columns-vertically","reverse-column-order","set-columns-width-50","menu_id","video_background","video_background_media","video_background_hide","aos-type","aos-duration","aos-easing","aos-offset","aos-delay","aos-anchor","aos-anchor-placement","aos-once","aos-enable","transform","grid-match-height-of-tallest-child","grid-column-count","grid-column-min-width","grid-column-max-width","grid-column-gap","grid-row-count","grid-row-behavior","grid-row-min-height","grid-row-max-height","grid-row-gap","grid-justify-items","grid-align-items","image-type","attachment-size"],ot.cache.idCSS="",ot.cache.idStyles={},ot.cache.classCSS="",ot.cache.classStyles={},ot.cache.selectorCSS="",ot.cache.selectorStyles={},ot.cache.mediaCSS="",ot.cache.mediaStyles={},ot.contentAdded=[],ot.socialIcons=[],ot.socialIcons.networks=["facebook","instagram","twitter","linkedin","rss","youtube"],ot.socialIcons.networkColors={facebook:"#3b5998",instagram:"#c32aa3",twitter:"#00b6f1",linkedin:"#007bb6",rss:"#ee802f",youtube:"#ff0000"},ot.socialIcons.networkHoverColors={facebook:"#5b79b8",instagram:"#e34ac3",twitter:"#20d6ff",linkedin:"#209bd6",rss:"#ffa04f",youtube:"#ff4444"},ot.mappedSelectors={},ot.filterStylesheets=function(t){var e=ot.styleSheets.filter(function(e){return e.id==t.parent});return!(0<e.length&&0===e[0].status)&&-1!==parseInt(t.parent)},ot.setSelectedSelectorFolder=function(e){ot.setSelectedNodeType("selectorfolder"),ot.selectedSelectorFolder=e},ot.getCSSFolder=function(e){return ot.styleSheets.find(function(e){return e.id===iframeScope.selectedCSSFolder})},ot.setSelectedCSSFolder=function(e){ot.selectedCSSFolder=e},ot.setActiveCSSFolder=function(e){ot.setSelectedNodeType("cssfolder")},ot.setSelectedNodeType=function(e){"stylesheet"!==e&&s.toggleSidebar(!0),ot.selectedNodeType=e},ot.greaterThan=function(t,o){return function(e){return e[t]>o}},ot.equalsTo=function(t,o){return function(e){return e[t]===o}},ot.toggleCSSFolder=function(e){ot.cssFolderMenuOpen=null,e.status=1==e.status?0:1},ot.toggleSelectorFolder=function(e){e.status=1==e.status?0:1},ot.checkNewCustomSelector=function(e){void 0===ot.customSelectors[e]&&(ot.customSelectors[e]={set_name:"Uncategorized Custom Selectors",original:{}}),void 0===ot.customSelectors[e].set_name&&(ot.customSelectors[e].set_name="Uncategorized Custom Selectors"),void 0===ot.customSelectors[e].original&&(ot.customSelectors[e].original={})},ot.setCustomSelectorToEdit=function(e){if(ot.styleSetActive=!1,0<ot.component.active.id&&(ot.activeSelectors[ot.component.active.id]=void 0!==ot.activeSelectors[ot.component.active.id]?ot.activeSelectors[ot.component.active.id]:ot.component.options[ot.component.active.id].model.activeselector,ot.activeSelectors[ot.component.active.id]&&ot.setCurrentClass(!!ot.activeSelectors[ot.component.active.id]&&ot.activeSelectors[ot.component.active.id])),ot.log&&console.log("setCustomSelectorToEdit()",e),"string"==typeof(ot.selectorToEdit=e)){ot.activateComponent(-1,"ct_selector");var t=e.substr(1);ot.classes[t]?(ot.setCurrentClass(t),ot.populateSelectorFolderDropdown(!0),ot.setSelectedNodeType("class")):(ot.setCurrentClass(!1),ot.populateSelectorFolderDropdown(),ot.setSelectedNodeType("selector")),ot.customSelectors[e]&&(ot.expandedStyleSets[ot.customSelectors[e].set_name]=!0)}ot.highlightSelector(!0,e),s.cleanEmptySelectors&&""!==e&&s.cleanEmptySelectors()},ot.setStyleSetActive=function(){ot.setSelectedNodeType("styleset"),ot.styleSetActive=!0,ot.selectorToEdit=!1,ot.currentClass=!1},ot.populateSelectorFolderDropdown=function(e){var t,o="";e?(t=ot.classes[ot.currentClass])&&(o=t.parent):ot.selectedStyleSet?o=ot.styleSets[ot.selectedStyleSet].parent:(t=ot.customSelectors[ot.selectorToEdit])&&(o=t.parent);ot.currentActiveFolder=o},ot.setStyleSheetToEdit=function(e){var t=_.findWhere(ot.styleSheets,{id:e.parent});if(ot.currentActiveStylesheetFolder=t?t.name:"",ot.cancelDeleteUndo(),ot.log&&console.log("setStyleSheetToEdit()",e),ot.activateComponent(0),ot.stylesheetToEdit=e,ot.parentScope.switchActionTab("styleSheet"),ot.setSelectedNodeType("stylesheet"),ot.parentScope.expandSidebar(),window.parent.currentCMEditor){var o=window.parent.OxyCM,r=o.EditorState.create({extensions:[o.basicSetup,o.modules.keymap.of([o.modules.indentWithTab]),o.modules.css(),window.parent.currentCMWrap.of("true"===ot.globalCodeMirrorWrap?[o.EditorView.lineWrapping,o.modules.search()]:o.modules.search()),window.parent.currentCMTheme.of(o.modules[ot.globalCodeMirrorTheme])],doc:e.css});window.parent.currentCMEditor.setState(r)}},ot.updateStylesheetCSS=function(e){ot.stylesheetToEdit.css=e},ot.highlightSelector=function(e,t,o){if(ot.log&&console.log("highlightSelector()",e,t),!1===t)return ot.outputCSSStyles("ct-selector-highlight",""),!1;o&&o.stopPropagation();var r="";if(void 0===t&&(t=ot.selectorToEdit),ot.selectorHighlighted=void 0===e?!ot.selectorHighlighted:e,ot.selectorHighlighted){var a=[];try{a=t.indexOf(".")<0&&t.indexOf("#")<0&&t.indexOf("body")<0?angular.element(t,".oxygen-body"):angular.element(t)}catch(e){console.log(e)}if(0==a.length)return ot.selectorHighlighted=!1,ot.outputCSSStyles("ct-selector-highlight",""),!1}var i="";i="original"==ot.currentState||"hover"==ot.currentState||"active"==ot.currentState||"focus"==ot.currentState?"":":"+ot.currentState,ot.selectorHighlighted&&(r=t+i+"{outline: 1px dashed rgb(19, 187, 38); outline-offset: 0px;}",t.indexOf(".")<0&&t.indexOf("#")<0&&t.indexOf("body")<0&&(r=".oxygen-body "+r)),ot.outputCSSStyles("ct-selector-highlight",r)},ot.deleteSelectorFolder=function(t){if(ot.styleFolders.hasOwnProperty(t)){if((_.findWhere(ot.styleSets,{parent:t})||_.findWhere(ot.classes,{parent:t}))&&!confirm("Are you sure you wish to delete this folder and all classes and selectors inside it?"))return!1;angular.forEach(iframeScope.styleSets,function(e){e.parent===t&&delete iframeScope.styleSets[e.key]}),angular.forEach(iframeScope.classes,function(e){e.parent===t&&delete iframeScope.classes[e.key]}),delete ot.styleFolders[t]}},ot.toggleUncategorizedFolderContents=function(e){e?(_.each(_.filter(ot.styleSets,function(e){return void 0===e.parent||null===e.parent}),function(e){e.parent=-1}),_.each(_.filter(ot.classes,function(e){return void 0===e.parent||null===e.parent}),function(e){e.parent=-1})):(_.each(_.filter(ot.styleSets,function(e){return-1===e.parent||"-1"===e.parent}),function(e){delete e.parent}),_.each(_.filter(ot.classes,function(e){return-1===e.parent||"-1"===e.parent}),function(e){delete e.parent}))},ot.toggleUncategorizedStyleSheets=function(e){e?_.each(_.filter(ot.styleSheets,function(e){return void 0===e.parent||null===e.parent||0===parseInt(e.parent)}),function(e){e.parent=-1}):_.each(_.filter(ot.styleSheets,function(e){return-1===e.parent||"-1"===e.parent}),function(e){e.parent=0})},ot.addSelectorFolder=function(){ot.cancelDeleteUndo();var e=prompt("Provide a name for the folder").trim();/^[a-z_-][a-z\d_-]*$/i.test(e)?ot.styleFolders.hasOwnProperty(e)?alert("'"+e+"' already exist."):ot.styleFolders[e]={status:1}:alert("Bad folder name. Special characters and spaces are not allowed")},ot.addSelectorItem=function(){ot.cancelDeleteUndo();var e=prompt("Type a valid CSS selector").trim();try{document.querySelector(e)}catch(e){return alert("Not a valid selector"),!1}if(ot.customSelectors.hasOwnProperty(e))alert("'"+e+"' already exist.");else{ot.customSelectors[e]={set_name:"Uncategorized Custom Selectors",original:{}},ot.selectedSelectorFolder&&ot.styleFolders.hasOwnProperty(ot.selectedSelectorFolder)&&(ot.customSelectors[e].parent=ot.selectedSelectorFolder),ot.setCustomSelectorToEdit(e),ot.selectedStyleSet=e,ot.expandedStyleSets["Uncategorized Custom Selectors"]=!0;var t=ot.styleSets["Uncategorized Custom Selectors"].parent;void 0===t?iframeScope.expandedSelectorFolder[0]=!0:-1===t?iframeScope.expandedSelectorFolder.uncategorized=!0:iframeScope.expandedSelectorFolder[t]=!0}},ot.addStyleSheet=function(e){ot.cancelDeleteUndo();var t=prompt("Enter a name for the "+(e?"Folder":"Stylesheet"));if(t){t=t.trim();if(/^[a-z_-][a-z\d_-]*$/i.test(t))if(0<ot.styleSheets.filter(function(e){return e.name==t}).length)alert("'"+t+"' already exist. Please choose another name.");else{var o=1;if(0<ot.styleSheets.length&&(o=_.max(ot.styleSheets,function(e){return e.id}).id+1),e)ot.styleSheets.push({id:o,name:t,status:1,folder:1});else{var r=-1===ot.selectedCSSFolder||null===ot.selectedCSSFolder?0:ot.selectedCSSFolder,a={id:o,name:t,css:"",parent:r};for(key in ot.styleSheets.push(a),iframeScope.expandedFolder)iframeScope.expandedFolder[key]=!1;iframeScope.expandedFolder[r]=!0,iframeScope.setStyleSheetToEdit(a)}}else alert("Bad stylesheet name. Special characters and spaces are not allowed")}},ot.deleteStyleSheet=function(t){if(ot.cancelDeleteUndo(),t.folder){if(!confirm("Are you sure you wish to delete this folder and all stylesheets inside it?"))return!1}else if(!confirm('Delete "'+t.name+'" stylesheet from install? (Changes will take effect on Save).'))return!1;ot.log&&console.log("deleteStyleSheet()",selector),ot.styleSheets.splice(ot.styleSheets.indexOf(t),1),t.folder&&(ot.styleSheets=ot.styleSheets.filter(function(e){return e.parent!=t.id})),angular.element(document.getElementById("ct-style-sheet-"+t.name)).remove(),ot.stylesheetToEdit===t&&(ot.stylesheetToEdit=!1,s.actionTabs.styleSheet=!1,s.toggleSidebar(!0)),ot.selectedCSSFolder===t.id&&(ot.selectedCSSFolder=null),ot.selectedNodeType=null},ot.deleteCustomSelector=function(e){return ot.cancelDeleteUndo(),"Uncategorized Custom Selector"===e?(alert("Sorry, you can't delete the Style Set named Uncategorized Custom Selectors"),!1):!!confirm('Are you sure to delete "'+e+'" selector?')&&(ot.log&&console.log("deleteCustomSelector()",e),delete ot.customSelectors[e],ot.selectorToEdit=!1,-1==ot.component.active.id&&ot.activateComponent(0,"root"),ot.classesCached=!1,ot.outputCSSOptions(),void ot.unsavedChanges())},ot.updateCustomSelectorValue=function(e,t){if(ot.cancelDeleteUndo(),ot.log&&console.log("updateCustomSelectorValue()",e,t),""===ot.selectorToEdit)return!1;var o=ot.currentState,r=ot.selectorToEdit.substr(1);ot.classes[r]?ot.isEditing("media")?(ot.classes[ot.currentClass].media||(ot.classes[ot.currentClass].media={}),ot.classes[ot.currentClass].media[ot.currentMedia]||(ot.classes[ot.currentClass].media[ot.currentMedia]={}),ot.classes[ot.currentClass].media[ot.currentMedia][o]||(ot.classes[ot.currentClass].media[ot.currentMedia][o]={}),""==t?delete ot.classes[ot.currentClass].media[ot.currentMedia][o][e]:ot.classes[ot.currentClass].media[ot.currentMedia][o][e]=t):(ot.classes[r][o]||(ot.classes[r][o]={}),""==t?delete ot.classes[r][o][e]:ot.classes[r][o][e]=t):ot.isEditing("media")?(ot.customSelectors[ot.selectorToEdit].media||(ot.customSelectors[ot.selectorToEdit].media={}),ot.customSelectors[ot.selectorToEdit].media[ot.currentMedia]||(ot.customSelectors[ot.selectorToEdit].media[ot.currentMedia]={}),ot.customSelectors[ot.selectorToEdit].media[ot.currentMedia][o]||(ot.customSelectors[ot.selectorToEdit].media[ot.currentMedia][o]={}),""==t?delete ot.customSelectors[ot.selectorToEdit].media[ot.currentMedia][o][e]:ot.customSelectors[ot.selectorToEdit].media[ot.currentMedia][o][e]=t):(ot.customSelectors[ot.selectorToEdit]||(ot.customSelectors[ot.selectorToEdit]={set_name:"Uncategorized Custom Selectors"}),ot.customSelectors[ot.selectorToEdit][o]||(ot.customSelectors[ot.selectorToEdit][o]={}),""==t?delete ot.customSelectors[ot.selectorToEdit][o][e]:ot.customSelectors[ot.selectorToEdit][o][e]=t)},ot.outputCSSStyles=function(e,t){var o=document.getElementById(e),r="";r='<style id="'+e+'">',r+=t,r+="</style>",o?o.innerHTML=t:angular.element("head").append(r)},ot.deleteCSSStyles=function(e){var t=document.getElementById(e);t&&angular.element(t).remove()},ot.generateDynamicBackgrounds=function(o,e,r,a,t){void 0===t&&(t=ot.componentsTree),ot.dynamicBackgrounds=ot.dynamicBackgrounds||{};var i={lock:!0};"id"===r?(ot.dynamicBackgrounds[o]=ot.dynamicBackgrounds[o]||{},ot.dynamicBackgrounds[o]=i):"class"===r?(ot.dynamicBackgrounds.classes=ot.dynamicBackgrounds.classes||{},ot.dynamicBackgrounds.classes[o]=ot.dynamicBackgrounds.classes[o]||{},ot.dynamicBackgrounds.classes[o]=i):"selector"===r&&(ot.dynamicBackgrounds.selectors=ot.dynamicBackgrounds.selectors||{},ot.dynamicBackgrounds.selectors[o]=ot.dynamicBackgrounds.selectors[o]||{},ot.dynamicBackgrounds.selectors[o]=i);var n={};if("id"===r){var s=ot.findComponentItem(t.children,o,ot.getComponentItem);n=s?s.options:{}}else"class"===r?n=ot.classes[o]||{}:"selector"===r&&(n=ot.customSelectors[o]||{});var l=0;for(key in n)if(!(-1<["ct_id","ct_parent","set_name","parent","key","status","friendly_name","selector","activeselector","classes","nicename"].indexOf(key)))if("media"===key){i.media={};var c=n.media;for(bpKey in c)for(stateKey in i.media[bpKey]={},c[bpKey])"id"===r&&c[bpKey][stateKey]["background-image"]&&-1<c[bpKey][stateKey]["background-image"].indexOf("[oxygen")&&(i.media[bpKey][stateKey]=c[bpKey][stateKey]["background-image"],l++)}else"id"===r&&n[key]&&n[key]["background-image"]&&-1<n[key]["background-image"].indexOf("[oxygen")&&(i[key]=n[key]["background-image"],l++);for(key in i)if("lock"!==key)if("media"===key){c=i.media;for(bpKey in c)for(stateKey in c[bpKey])ot.applyShortcodeResults(o,i.media[bpKey][stateKey],function(e,t){if("selector"===r?ot.dynamicBackgrounds.selectors[o].media[t.bpKey][t.stateKey]=e.trim():"class"===r?ot.dynamicBackgrounds.classes[o].media[t.bpKey][t.stateKey]=e.trim():"id"===r&&(ot.dynamicBackgrounds[o].media[t.bpKey][t.stateKey]=e.trim()),0===--l)return delete i.lock,void a()},{id:o,bpKey:bpKey,stateKey:stateKey})}else ot.applyShortcodeResults(o,i[key],function(e,t){if("selector"===r?ot.dynamicBackgrounds.selectors[o][t.key]=e.trim():"class"===r?ot.dynamicBackgrounds.classes[o][t.key]=e.trim():"id"===r&&(ot.dynamicBackgrounds[o][t.key]=e.trim()),0===--l)return delete i.lock,void a()},{id:o,key:key});0===l&&(delete i.lock,a())},ot.outputCSSOptions=function(e,r,t){ot.APIElementsDefaultCSS=[],ot.log&&(console.log("outputCSSOptions()",e),ot.functionStart("outputCSSOptions()"));if(ot.bufferedOutputStyles=ot.bufferedOutputStyles||{},ot.bufferedOutputStyles.keys=ot.bufferedOutputStyles.keys||[],(ot.isEditing("class")||ot.isEditing("id")||1==r)&&ot.bufferedOutputStyles.keys.indexOf("id")<0&&ot.bufferedOutputStyles.keys.push("id"),!ot.isEditing("class")&&ot.classesCached||ot.bufferedOutputStyles.keys.indexOf("classes")<0&&ot.bufferedOutputStyles.keys.push("classes"),ot.bufferedOutputStyles.keys.indexOf("selectors")<0&&ot.bufferedOutputStyles.keys.push("selectors"),(ot.isEditing("class")||ot.isEditing("id")||1==r)&&(void 0!==e&&0<e?ot.updateComponentCacheStyles(e,function(){ot.cache.idCSS="",Object.keys(ot.cache.idStyles).map(function(e,t){ot.cache.idCSS+=ot.cache.idStyles[e]}),ot.outputCSSStylesAfterWait("id",ot.cache.idCSS)}):(Object.keys(ot.cache.idStyles).map(function(e,t){ot.cache.idCSS+=ot.cache.idStyles[e]}),ot.outputCSSStylesAfterWait("id",ot.cache.idCSS))),ot.isEditing("class")||!ot.classesCached)if(ot.classesCached)void 0!==ot.classes[ot.currentClass]&&void 0!==ot.classes[ot.currentClass].parent&&void 0!==ot.styleFolders[ot.classes[ot.currentClass].parent]&&1!==ot.styleFolders[ot.classes[ot.currentClass].parent].status||-1!==parseInt(ot.classes[ot.currentClass].parent)&&(ot.cache.classStyles[ot.currentClass]=ot.getSingleClassCSS(ot.currentClass)),ot.cache.classCSS="",Object.keys(ot.cache.classStyles).map(function(e,t){ot.cache.classCSS+=ot.cache.classStyles[e]}),ot.outputCSSStylesAfterWait("classes",ot.cache.classCSS);else{var a=function(e){var t=function(){0<c.length&&a(c.shift())};if(ot.classes.hasOwnProperty(e)){var o=ot.classes[e];ot.cache.classStyles[e]="",(void 0===ot.classes[e].parent||void 0===ot.styleFolders[ot.classes[e].parent]||1===ot.styleFolders[ot.classes[e].parent].status)&&-1!==parseInt(ot.classes[e].parent)?ot.generateDynamicBackgrounds(e,r,"class",function(){ot.cache.classStyles[e]=ot.getSingleClassCSS(e,o),t()}):t()}else t()};ot.cache.classStyles=[];var o=Object.keys(ot.classes);if(0<o.length){var i=Math.ceil(o.length/1e3);if(i<=1)a((c=o).shift());else for(var n=0;n<i;n++){var s=1e3*n,l=s+1e3,c=o.slice(s,l);a(c.shift())}ot.cache.classCSS="",Object.keys(ot.cache.classStyles).map(function(e,t){ot.cache.classCSS+=ot.cache.classStyles[e]}),ot.outputCSSStylesAfterWait("classes",ot.cache.classCSS),ot.classesCached=!0}else ot.cache.classCSS="",ot.outputCSSStylesAfterWait("classes",ot.cache.classCSS),ot.classesCached=!0}ot.cache.selectorStyles=[],ot.cache.selectorCSS="";var p=Object.keys(ot.customSelectors),d=function(e){var t=function(){0<p.length?d(p.shift()):(ot.cache.selectorCSS="",Object.keys(ot.cache.selectorStyles).map(function(e,t){ot.cache.selectorCSS+=ot.cache.selectorStyles[e]}),ot.outputCSSStylesAfterWait("selectors",ot.cache.selectorCSS))};if(ot.customSelectors.hasOwnProperty(e)){var o=ot.customSelectors[e];ot.cache.selectorStyles[e]="",!(void 0!==ot.customSelectors[e].set_name&&void 0!==ot.styleSets[ot.customSelectors[e].set_name]&&void 0!==ot.styleSets[ot.customSelectors[e].set_name].parent&&void 0!==ot.styleFolders[ot.styleSets[ot.customSelectors[e].set_name].parent]&&void 0!==ot.styleFolders[ot.styleSets[ot.customSelectors[e].set_name].parent].status&&1!==ot.styleFolders[ot.styleSets[ot.customSelectors[e].set_name].parent].status||void 0!==ot.styleSets[ot.customSelectors[e].set_name]&&-1===parseInt(ot.styleSets[ot.customSelectors[e].set_name].parent))?ot.generateDynamicBackgrounds(e,r,"selector",function(){ot.cache.selectorStyles[e]=ot.getSingleSelectorCSS(e,o),t()}):t()}else t()};0<p.length?d(p.shift()):ot.outputCSSStylesAfterWait("selectors",ot.cache.selectorCSS),ot.functionEnd("outputCSSOptions()")},ot.outputCSSStylesAfterWait=function(e,t){"id"===e&&(ot.idStylesContainer.innerHTML=t),"classes"===e&&(ot.classStylesContainer.innerHTML=t),"selectors"===e&&ot.outputCSSStyles("ct-custom-selectors",t)},ot.updateComponentCacheStyles=function(e,t,o){ot.contentAdded=[],ot.log&&console.log("updateComponentCacheStyles()",e,ot.component.options[e]),ot.generateDynamicBackgrounds(e,!1,"id",function(){ot.cache.idStyles[e]=ot.getSingleComponentCSS(ot.component.options[e],e,null,null,o),t&&t()})},ot.updateAllComponentsCacheStyles=function(){for(var e in ot.APIElementsDefaultCSS=[],ot.functionStart("updateAllComponentsCacheStyles()"),ot.component.options)ot.component.options.hasOwnProperty(e)&&ot.updateComponentCacheStyles(e,function(){ot.cache.idCSS="",Object.keys(ot.cache.idStyles).map(function(e,t){ot.cache.idCSS+=ot.cache.idStyles[e]}),ot.outputCSSStylesAfterWait("id",ot.cache.idCSS)});ot.functionEnd("updateAllComponentsCacheStyles()")},ot.removeComponentCacheStyles=function(e){delete ot.cache.idStyles[e]},ot.getDynamicBackground=function(e,t){var o;return"id"===e&&ot.dynamicBackgrounds[t.id]?o=ot.dynamicBackgrounds[t.id]:"class"===e&&ot.dynamicBackgrounds.classes[t.id]?o=ot.dynamicBackgrounds.classes[t.id]:"selector"===e&&ot.dynamicBackgrounds.selectors[t.id]&&(o=ot.dynamicBackgrounds.selectors[t.id]),t.media?o.media[t.media]["id"===t.stateName?"original":t.stateName]:o["id"===t.stateName?"original":t.stateName]},ot.getSingleComponentCSS=function(e,o,t,r,a){if("ct_reusable"==e.name&&e.original){ot.reusableCSS={},ot.reusableCSS.styles="  ";var i=e.original.view_id;return ot.postsData[i]&&(ot.generateTreeCSS(ot.postsData[i].post_tree,ot.reusableCSS),ot.outputCSSStyles("ct-re-usable-styles-"+i,ot.reusableCSS.styles)),""}ot.log&&(console.log("getSingleComponentCSS()",o,e,t),ot.functionStart("getSingleComponentCSS()"));var n="",s="",l="",c=ot.defaultOptions[e.name];for(var p in null==e.original&&(e.original=[]),e)if(e.hasOwnProperty(p)){var d=e[p];if("original"==p&&!t)continue;if(0!=o&&"object"==typeof d&&"sizes"!=p&&"sizes_requested"!=p&&"model"!=p&&"classes"!=p&&"media"!=p){var g,m,u,_,y,h,b,x=angular.copy(e[p]),S=ot.getCSSOptions(o,p,x,e.name,r,{id:o,state:p});if(mergedOriginalOptions=angular.copy(e.original),originalOptions=ot.getCSSOptions(o,"original",mergedOriginalOptions,e.name,r,{id:o,state:p}),l="id"==p||t&&"original"==p||p==ot.currentState&&o==ot.component.active.id&&ot.isEditing("id")&&("hover"==p||"active"==p||"focus"==p)?"":":"+p,s="ct_paragraph"==e.name?" p":"",a){n+="#"+e.selector+'[ng-attr-component-id="'+o+'"]'+s+l+"{",n+=ot.getBackgroundLayersCSS(S,e.name,"id",o,r,p)||"",n+="}";continue}if("ct_columns"==e.name){var f=ot.getWidth(e.original.gutter);n+="#"+e.selector+" .ct-column"+l+"{",n+="margin-right:"+f.value/2+f.unit+";",n+="margin-left:"+f.value/2+f.unit+";",n+="}"}if("true"==e.original.dont_render&&(n+="#"+e.selector+"{",e.original["placeholder-width"]&&(n+="width:"+e.original["placeholder-width"]+(e.original["placeholder-width-unit"]||c["placeholder-width-unit"])+";"),e.original["placeholder-height"]&&(n+="height:"+e.original["placeholder-height"]+(e.original["placeholder-height-unit"]||c["placeholder-height-unit"])+";"),n+="}"),"ct_section"==e.name){S.display&&"none"==S.display&&(n+="#"+e.selector+l+"{ display: "+S.display+"; }"),S.display&&"none"!=S.display&&(n+="#"+e.selector+l+"{ display: block; }"),n+="#"+e.selector+">.ct-section-inner-wrap"+l+"{",null==S["section-width"]&&(S["section-width"]=c["section-width"]),S["section-width"],"custom"==S["section-width"]&&S["custom-width"]&&(n+="max-width:"+S["custom-width"]+";"),"full-width"==S["section-width"]&&(n+="max-width:100%;"),S["container-padding-top"]&&(n+="padding-top:"+S["container-padding-top"]+";"),S["container-padding-right"]&&(n+="padding-right:"+S["container-padding-right"]+";"),S["container-padding-bottom"]&&(n+="padding-bottom:"+S["container-padding-bottom"]+";"),S["container-padding-left"]&&(n+="padding-left:"+S["container-padding-left"]+";"),S.display&&"grid"!=S["flex-direction"]&&(n+="display:"+S.display+";");var v="reverse"==S["flex-reverse"]?"-reverse":"";S["flex-direction"]&&"grid"!=S["flex-direction"]&&(n+="flex-direction:"+S["flex-direction"]+v+";"),S["justify-content"]&&(n+="justify-content:"+S["justify-content"]+";"),S["align-content"]&&(n+="align-content:"+S["align-content"]+";"),S["align-items"]&&(n+="align-items:"+S["align-items"]+";"),S["flex-wrap"]&&(n+="flex-wrap:"+S["flex-wrap"]+";"),S.gap&&(n+="gap:"+S.gap+";"),n+=ot.getGridCSS(S,e.name)||"",n+="}",n+=ot.getGridChildCSS(S,e.selector,l,"> .ct-section-inner-wrap"),e.original.video_background_hide&&(n+="@media (max-width: "+ot.getMediaMaxSize(e.original.video_background_hide)+") {",n+="#"+e.selector+" .oxy-video-container { display: none; }",n+="}"),e.original.video_background_overlay&&(n+="#"+e.selector+" .oxy-video-overlay { background-color: "+e.original.video_background_overlay+"; }")}if("ct_section"==e.name&&(n+=ot.getGridChildCSS(S,e.selector,l,!1)),"oxy_posts_grid"==e.name){var C=ot.getGridCSS(S,e.name,"!important")||"";C&&(n+="#"+e.selector+"> .oxy-posts"+l+"{",n+=C,n+="}",n+="#"+e.selector+l+"{",n+="flex-direction: column",n+="}",n+=ot.getGridChildCSS(S,e.selector,l,"> .oxy-posts"))}if("ct_section"!=e.name&&"oxy_posts_grid"!=e.name&&"oxy_dynamic_list"!=e.name&&(n+=ot.getGridChildCSS(S,e.selector,l)),"oxy_dynamic_list"==e.name&&(n+=ot.getGridChildCSS(S,e.selector,l,"",!1,"is repeater"),ot.mapCSSProperty("paginate_size","font-size",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_color","color",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_alignment","justify-content",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_wrap_alignment","justify-content",".oxy-repeater-pages-wrap"),ot.mapCSSProperty("paginate_link_color","color",".oxy-repeater-pages a.page-numbers"),ot.mapCSSProperty("paginate_link_hover_color","color",".oxy-repeater-pages a.page-numbers:hover"),ot.mapCSSProperty("paginate_padding_top","padding-top",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_padding_left","padding-left",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_padding_right","padding-right",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_padding_bottom","padding-bottom",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_margin_top","margin-top",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_margin_left","margin-left",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_margin_right","margin-right",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_margin_bottom","margin-bottom",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_width","width",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_min_width","min-width",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_max_width","max-width",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_height","height",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_min_height","min-height",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_max_height","max-height",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_flex_direction","flex-direction",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_flex_wrap","flex-wrap",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_all_color","border-color",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_top_color","border-top-color",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_left_color","border-left-color",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_bottom_color","border-bottom-color",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_right_color","border-right-color",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_all_width","border-width",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_top_width","border-top-width",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_left_width","border-left-width",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_bottom_width","border-bottom-width",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_right_width","border-right-width",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_all_style","border-style",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_top_style","border-top-style",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_left_style","border-left-style",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_bottom_style","border-bottom-style",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_right_style","border-right-style",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_radius","border-radius",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages"),ot.mapCSSProperty("paginatelink_border_all_color","border-color",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_top_color","border-top-color",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_left_color","border-left-color",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_bottom_color","border-bottom-color",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_right_color","border-right-color",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_all_width","border-width",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_top_width","border-top-width",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_left_width","border-left-width",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_bottom_width","border-bottom-width",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_right_width","border-right-width",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_all_style","border-style",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_top_style","border-top-style",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_left_style","border-left-style",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_bottom_style","border-bottom-style",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_right_style","border-right-style",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_radius","border-radius",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelinkactive_border_all_color","border-color",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_top_color","border-top-color",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_left_color","border-left-color",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_bottom_color","border-bottom-color",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_right_color","border-right-color",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_all_width","border-width",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_top_width","border-top-width",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_left_width","border-left-width",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_bottom_width","border-bottom-width",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_right_width","border-right-width",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_all_style","border-style",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_top_style","border-top-style",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_left_style","border-left-style",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_bottom_style","border-bottom-style",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_right_style","border-right-style",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_radius","border-radius",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginate_background_color","background-color",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_background_image","background-image",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_background_size","background-size",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_background_size_width","background-size-width",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_background_size_height","background-size-height",".oxy-repeater-pages"),ot.mapCSSProperty("paginate_background_repeat","background-repeat",".oxy-repeater-pages"),ot.mapCSSProperty("paginatelink_background_color","background-color",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_background_image","background-image",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_background_size","background-size",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_background_size_width","background-size-width",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_background_size_height","background-size-height",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_background_repeat","background-repeat",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelinkactive_background_color","background-color",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_background_image","background-image",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_background_size","background-size",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_background_size_width","background-size-width",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_background_size_height","background-size-height",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_background_repeat","background-repeat",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelink_padding_top","padding-top",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_padding_left","padding-left",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_padding_right","padding-right",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_padding_bottom","padding-bottom",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_margin_top","margin-top",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_margin_left","margin-left",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_margin_right","margin-right",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_margin_bottom","margin-bottom",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_width","width",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_min_width","min-width",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_max_width","max-width",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_height","height",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_min_height","min-height",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelink_max_height","max-height",".oxy-repeater-pages a"),ot.mapCSSProperty("paginatelinkactive_padding_top","padding-top",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_padding_left","padding-left",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_padding_right","padding-right",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_padding_bottom","padding-bottom",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_margin_top","margin-top",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_margin_left","margin-left",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_margin_right","margin-right",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_margin_bottom","margin-bottom",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_width","width",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_min_width","min-width",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_max_width","max-width",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_height","height",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_min_height","min-height",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkactive_max_height","max-height",".oxy-repeater-pages span.current"),ot.mapCSSProperty("paginatelinkhover_background_color","background-color",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_background_image","background-image",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_background_size","background-size",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_background_size_width","background-size-width",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_background_size_height","background-size-height",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_background_repeat","background-repeat",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkactivehover_background_color","background-color",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_background_image","background-image",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_background_size","background-size",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_background_size_width","background-size-width",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_background_size_height","background-size-height",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_background_repeat","background-repeat",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkhover_padding_top","padding-top",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_padding_left","padding-left",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_padding_right","padding-right",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_padding_bottom","padding-bottom",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_margin_top","margin-top",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_margin_left","margin-left",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_margin_right","margin-right",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_margin_bottom","margin-bottom",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_width","width",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_min_width","min-width",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_max_width","max-width",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_height","height",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_min_height","min-height",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_max_height","max-height",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkactivehover_padding_top","padding-top",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_padding_left","padding-left",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_padding_right","padding-right",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_padding_bottom","padding-bottom",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_margin_top","margin-top",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_margin_left","margin-left",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_margin_right","margin-right",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_margin_bottom","margin-bottom",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_width","width",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_min_width","min-width",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_max_width","max-width",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_height","height",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_min_height","min-height",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_max_height","max-height",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkhover_border_all_color","border-color",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_top_color","border-top-color",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_left_color","border-left-color",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_bottom_color","border-bottom-color",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_right_color","border-right-color",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_all_width","border-width",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_top_width","border-top-width",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_left_width","border-left-width",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_bottom_width","border-bottom-width",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_right_width","border-right-width",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_all_style","border-style",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_top_style","border-top-style",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_left_style","border-left-style",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_bottom_style","border-bottom-style",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_right_style","border-right-style",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_radius","border-radius",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkhover_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages a:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_all_color","border-color",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_top_color","border-top-color",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_left_color","border-left-color",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_bottom_color","border-bottom-color",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_right_color","border-right-color",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_all_width","border-width",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_top_width","border-top-width",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_left_width","border-left-width",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_bottom_width","border-bottom-width",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_right_width","border-right-width",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_all_style","border-style",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_top_style","border-top-style",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_left_style","border-left-style",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_bottom_style","border-bottom-style",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_right_style","border-right-style",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_radius","border-radius",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_top_left_radius","border-top-left-radius",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_top_right_radius","border-top-right-radius",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_bottom_right_radius","border-bottom-right-radius",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginatelinkactivehover_border_bottom_left_radius","border-bottom-left-radius",".oxy-repeater-pages span.current:hover"),ot.mapCSSProperty("paginate_link_transition","transition",".oxy-repeater-pages > *")),"oxy_posts_grid"==e.name&&(ot.mapCSSProperty("title_size","font-size",".oxy-post-title"),ot.mapCSSProperty("title_color","color",".oxy-post-title"),ot.mapCSSProperty("title_hover_color","color",".oxy-post-title:hover"),ot.mapCSSProperty("meta_size","font-size",".oxy-post-meta"),ot.mapCSSProperty("meta_color","color",".oxy-post-meta"),ot.mapCSSProperty("content_size","font-size",".oxy-post-content"),ot.mapCSSProperty("content_color","color",".oxy-post-content"),ot.mapCSSProperty("read_more_size","font-size",".oxy-read-more"),ot.mapCSSProperty("read_more_text_color","color",".oxy-read-more"),ot.mapCSSProperty("read_more_button_color","background-color",".oxy-read-more"),ot.mapCSSProperty("read_more_text_hover_color","color",".oxy-read-more:hover"),ot.mapCSSProperty("read_more_button_hover_color","background-color",".oxy-read-more:hover"),ot.mapCSSProperty("paginate_color","color",".oxy-easy-posts-pages"),ot.mapCSSProperty("paginate_alignment","text-align",".oxy-easy-posts-pages"),ot.mapCSSProperty("paginate_link_color","color",".oxy-easy-posts-pages a.page-numbers"),ot.mapCSSProperty("paginate_link_hover_color","color",".oxy-easy-posts-pages a.page-numbers:hover"),"button"==e.original.read_more_display_as?(n+="#"+e.selector+" .oxy-read-more {",n+="text-decoration:none;",n+="padding:0.75em 1.5em;",n+="line-height:1;",n+="border-radius:3px;",n+="display:inline-block;",n+="}"):(ot.unmapCSSProperty("background-color",".oxy-read-more"),ot.unmapCSSProperty("background-color",".oxy-read-more:hover")),n+="@media (max-width: "+ot.getMediaMaxSize(e.original.posts_5050_below)+") {",n+="#"+e.selector+" .oxy-post { width: 50% !important; }",n+="}",n+="@media (max-width: "+ot.getMediaMaxSize(e.original.posts_100_below)+") {",n+="#"+e.selector+" .oxy-post { width: 100% !important; }",n+="}"),"oxy_comment_form"==e.name&&(ot.mapCSSProperty("form_field_border_color","border-color","input, textarea"),ot.mapCSSProperty("form_field_text_color","color","input, textarea"),ot.mapCSSProperty("field_border_radius","border-radius","input, textarea"),ot.mapCSSProperty("submit_button_background_color","background-color","#submit"),ot.mapCSSProperty("submit_button_text_color","color","#submit")),"oxy_login_form"==e.name&&(ot.mapCSSProperty("form_field_border_color","border-color","input, textarea"),ot.mapCSSProperty("form_field_text_color","color","input, textarea"),ot.mapCSSProperty("field_border_radius","border-radius","input, textarea"),ot.mapCSSProperty("submit_button_background_color","background-color","input[type=submit]"),ot.mapCSSProperty("submit_button_text_color","color","input[type=submit]")),"oxy_search_form"==e.name&&(ot.mapCSSProperty("form_field_border_color","border-color","input, textarea"),ot.mapCSSProperty("form_field_text_color","color","input, textarea"),ot.mapCSSProperty("field_border_radius","border-radius","input, textarea"),ot.mapCSSProperty("submit_button_background_color","background-color","input[type=submit]"),ot.mapCSSProperty("submit_button_text_color","color","input[type=submit]")),"ct_video"==e.name){n=n+"#"+e.selector+">.oxygen-vsb-responsive-video-wrapper"+l+"{";var w=e.original["video-padding-bottom"]||c["video-padding-bottom"];w&&(n+="padding-bottom:"+w+";"),n+="}"}if("ct_new_columns"==e.name&&(g=e.original),"ct_new_columns"==e.name&&g["set-columns-width-50"]&&"never"!=g["set-columns-width-50"]&&(n+="@media (max-width: "+ot.getMediaMaxSize(g["set-columns-width-50"])+") {",n+="#"+e.selector+"> .ct-div-block {width: 50% !important;}",n+="}"),"ct_new_columns"==e.name){var k=parseInt(ot.getMediaMaxSize(g["reverse-column-order"]))||0,P=parseInt(ot.getMediaMaxSize(g["stack-columns-vertically"]))||0,O="",z="";"always"==g["reverse-column-order"]&&(k=9999999999),g["stack-columns-vertically"]&&"never"!=g["stack-columns-vertically"]&&(z+="@media (max-width: "+ot.getMediaMaxSize(g["stack-columns-vertically"])+") {",z+="#"+e.selector+"> .ct-div-block {",z+="width: 100% !important;",z+="}",z+="#"+e.selector+"{",z+=k<P?"flex-direction: column;":"flex-direction: column-reverse;",z+="}",z+="}"),g["reverse-column-order"]&&"never"!=g["reverse-column-order"]&&"always"!=g["reverse-column-order"]&&(O+="@media (max-width: "+ot.getMediaMaxSize(g["reverse-column-order"])+") {",O+="#"+e.selector+"{",O+=P<k?"flex-direction: row-reverse;":"flex-direction: column-reverse;",O+="}",O+="}"),"always"==g["reverse-column-order"]&&(n+="#"+e.selector+"{flex-direction: row-reverse;}"),P<k?(n+=O,n+=z):(n+=z,n+=O)}if("oxy_header"==e.name){n+="#"+e.selector+" .oxy-header-container"+l+"{",null==S["header-width"]&&(S["header-width"]=c["header-width"]),"custom"==S["header-width"]&&S["header-custom-width"]&&(n+="max-width:"+S["header-custom-width"]+";"),"full-width"==S["header-width"]&&(n+="max-width:100%;"),n+="}",e.original["overlay-header-above"]&&"never"!=e.original["overlay-header-above"]&&("always"!=e.original["overlay-header-above"]&&(n+="@media (min-width: "+ot.getMediaMinSize(e.original["overlay-header-above"])+") {"),n+="#"+e.selector+".oxy-header.oxy-overlay-header {position: absolute;left: 0;right: 0;z-index: 20;}#"+e.selector+".oxy-header.oxy-overlay-header:not(.oxy-sticky-header-active) .oxy-header-row,#"+e.selector+".oxy-header.oxy-overlay-header:not(.oxy-sticky-header-active){background-color: initial !important;}#"+e.selector+".oxy-header.oxy-overlay-header .oxygen-hide-in-overlay{display: none}#"+e.selector+".oxy-header.oxy-overlay-header .oxygen-only-show-in-overlay{display: block}","always"!=e.original["overlay-header-above"]&&(n+="}"));var T="";if(e.original["sticky-media"]&&"never"!=e.original["sticky-media"])"always"!=e.original["sticky-media"]&&(T+="@media (min-width: "+ot.getMediaMinSize(e.original["sticky-media"])+") {"),T+="#"+e.selector+".oxy-header-wrapper.oxy-header.oxy-sticky-header.oxy-sticky-header-active {",T+="position: fixed; top: 0; left: 0; right: 0; z-index: "+(e.original.sticky_zindex||"2147483640")+";",T+=e.original["sticky-background-color"]?"background-color:"+ot.getGlobalColorValue(e.original["sticky-background-color"])+";":"",T+="box-shadow:"+(e.original["sticky-box-shadow"]||c["sticky-box-shadow"])+";",T+="}",T+="#"+e.selector+".oxy-header.oxy-sticky-header-active .oxygen-hide-in-sticky {",T+="display:none;",T+="}",T+="#"+e.selector+".oxy-header.oxy-header .oxygen-show-in-sticky-only {",T+="display: none;",T+="}","always"!=e.original["sticky-media"]&&(T+="}");T&&(n+=T),e.original.sticky_header_fade_in_speed&&(n+="#"+e.selector+".oxy-sticky-header-active {animation-duration: "+e.original.sticky_header_fade_in_speed+"s;}")}if("oxy_header"==e.name||"oxy_header_row"==e.name){var G="";e.original["stack-header-vertically"]&&"never"!=e.original["stack-header-vertically"]&&(G+="@media (max-width: "+ot.getMediaMaxSize(e.original["stack-header-vertically"])+") {",G+="#"+e.selector+" .oxy-header-container {",G+="flex-direction: column;",G+="}",G+="#"+e.selector+" .oxy-header-container > div{",G+="justify-content: center;",G+="}",G+="}"),G&&(n+=G)}if("oxy_header_row"==e.name){n+="#"+e.selector+".oxy-header-row .oxy-header-container"+l+"{",null==S["header-row-width"]&&(S["header-row-width"]=c["header-row-width"]),"custom"==S["header-row-width"]&&S["header-row-custom-width"]&&(n+="max-width:"+S["header-row-custom-width"]+";"),"full-width"==S["header-row-width"]&&(n+="max-width:100%;"),"page-width"==S["header-row-width"]&&(n+="max-width:"+ot.getPageWidth()+"px;"),n+="}";var M="",V="";e.original["hide-row"]&&"never"!=e.original["hide-row"]&&(M+="@media (max-width: "+ot.getMediaMaxSize(e.original["hide-row"])+") {",M+="#"+e.selector+" {",M+="display: none;",M+="}",M+="}"),M&&(n+=M);var A=S.display||"block";V+=".oxy-header.oxy-sticky-header-active > #"+e.selector+".oxygen-show-in-sticky-only {",V+="display: "+A+";",n+=V+="}"}if("ct_slider"==e.name&&(t||"id"!=p||(S["slider-arrow-color"]&&"lighter"==S["slider-arrow-color"]&&(n+="#"+e.selector+" .unslider-arrow {",n+="background-color: rgba(255,255,255,0.2); ",n+="}"),S["slider-dot-color"]&&(n+="#"+e.selector+" .unslider-nav ol li {",n+="border-color: "+ot.getGlobalColorValue(S["slider-dot-color"])+"; ",n+="}",n+="#"+e.selector+" .unslider-nav ol li.unslider-active {",n+="background-color: "+ot.getGlobalColorValue(S["slider-dot-color"])+"; ",n+="}"),S["slider-remove-padding"]&&"yes"==S["slider-remove-padding"]&&(n+="#"+e.selector+" .unslider {",n+="padding: 0px; ",n+="}",n+="#"+e.selector+" .unslider-wrap.unslider-carousel > li {",n+="padding: 0px; ",n+="}",n+="#"+e.selector+" .unslider-arrow.next {",n+="right: 10px; ",n+="z-index: 100; ",n+="}",n+="#"+e.selector+" .unslider-arrow.prev {",n+="left: 10px; ",n+="z-index: 100; ",n+="}"),S["slider-dots-overlay"]&&"yes"==S["slider-dots-overlay"]&&(n+="#"+e.selector+" .unslider .unslider-nav {",n+="position: absolute; bottom: 0; left: 0; right: 0; z-index:100",n+="}"),S["slider-stretch-slides"]&&"yes"==S["slider-stretch-slides"]&&(n+="#"+e.selector+" .unslider-wrap {",n+="display: flex;",n+="}",n+="#"+e.selector+" .ct-slide {",n+="height: 100%;",n+="}",n+="#"+e.selector+" .unslider,",n+="#"+e.selector+" .oxygen-unslider-container,",n+="#"+e.selector+" .unslider-wrap,",n+="#"+e.selector+" .unslider-wrap li {",n+="height: 100%;",n+="}"),S["slider-stretch-slides"]&&"yes"==S["slider-stretch-slides"]&&S["slider-animation"]&&"fade"==S["slider-animation"]&&(n+="#"+e.selector+" .unslider-fade ul li.unslider-active {",n+="width: 100%;",n+="}"),S["slider-slide-padding"]&&(n+="#"+e.selector+" .ct-slide {",n+="padding: "+S["slider-slide-padding"],n+="}"))),"ct_link_button"==e.name){if(t||"id"!=p)I=!!ot.component.options[o]&&ot.component.options[o].original["button-style"],E=ot.getGlobalColorValue(S["button-color"]),F=S["button-size"],N=ot.getGlobalColorValue(S["button-text-color"]);else var I=originalOptions["button-style"]||c["button-style"],E=ot.getGlobalColorValue(S["button-color"]),F=S["button-size"],N=ot.getGlobalColorValue(S["button-text-color"]);if(n=n+"#"+e.selector+l+"{",1==I&&E&&(n+="background-color: "+ot.getGlobalColorValue(E)+";",n+="border: 1px solid "+E+";",N&&(n+="color: "+ot.getGlobalColorValue(N)+";")),2==I&&(n+="background-color: transparent;",E?(n+="border: 1px solid "+ot.getGlobalColorValue(E)+";",n+="color: "+ot.getGlobalColorValue(E)+";"):n+="color: "+ot.getGlobalColorValue(c["button-color"])+";"),F){var j=2==I?1:0;n+="padding: "+(parseInt(F)-j)+"px "+(1.6*parseInt(F)-j)+"px;"}n+="}"}if("ct_fancy_icon"==e.name){if(t||"id"!=p)K=!!ot.component.options[o]&&ot.component.options[o].original["icon-style"],B=ot.getGlobalColorValue(S["icon-color"]),D=ot.getGlobalColorValue(S["icon-background-color"]),H=S["icon-padding"],W=S["icon-size"];else var K=originalOptions["icon-style"]||c["icon-style"],B=ot.getGlobalColorValue(S["icon-color"]),D=ot.getGlobalColorValue(S["icon-background-color"])||c["icon-background-color"],H=S["icon-padding"]||c["icon-padding"]+c["icon-padding-unit"],W=S["icon-size"];n=n+"#"+e.selector+l+"{",1==K&&(n+="border: 1px solid;"),2==K&&D&&(n+="background-color: "+ot.getGlobalColorValue(D)+";",n+="border: 1px solid "+ot.getGlobalColorValue(D)+";"),1!=K&&2!=K||H&&(n+="padding:"+H+";"),B&&(n+="color:"+ot.getGlobalColorValue(B)+";"),n+="}",W&&(n=n+"#"+e.selector+l+">svg {",n+="width: "+W+";",n+="height: "+W+";",n+="}")}if("oxy_social_icons"==e.name){K=e.original["icon-style"]||c["icon-style"];var X=ot.getGlobalColorValue(e.original["icon-use-brand-colors"])||c["icon-use-brand-colors"];if(n+="#"+e.selector+".oxy-social-icons {",n+="flex-direction: "+(e.original["icon-layout"]||c["icon-layout"])+";",n+="margin-right: -"+(e.original["icon-space-between-icons"]||c["icon-space-between-icons"])+"px;",n+="margin-bottom: -"+(e.original["icon-space-between-icons"]||c["icon-space-between-icons"])+"px;",n+="}",n+="#"+e.selector+".oxy-social-icons a {",n+="font-size: "+(e.original["icon-size"]||c["icon-size"])+"px; ",n+="margin-right: "+(e.original["icon-space-between-icons"]||c["icon-space-between-icons"])+"px;",n+="margin-bottom: "+(e.original["icon-space-between-icons"]||c["icon-space-between-icons"])+"px;","circle"==K?n+="border-radius: 50%;":"square"==K&&(n+="border-radius: 0%;"),"blank"!=K&&(n+="background-color: "+(ot.getGlobalColorValue(e.original["icon-background-color"])||c["icon-background-color"])+";"),n+="}",n+="#"+e.selector+".oxy-social-icons a:hover {","blank"!=K&&(n+="background-color: "+(ot.getGlobalColorValue(e.original["icon-background-hover-color"])||c["icon-background-hover-color"])+";"),n+="}","yes"==X)for(var Y in ot.socialIcons.networks)if(ot.socialIcons.networks.hasOwnProperty(Y)){var U=ot.socialIcons.networks[Y],L=ot.socialIcons.networkColors[U],$=ot.socialIcons.networkHoverColors[U];"blank"!=K?(n+="#"+e.selector+".oxy-social-icons a.oxy-social-icons-"+U+" {",n+="background-color: "+L+";",n+="}",n+="#"+e.selector+".oxy-social-icons a.oxy-social-icons-"+U+":hover {",n+="background-color: "+$+";",n+="}",e.original["icon-color"]="#ffffff",e.original["icon-hover-color"]="#ffffff"):(n+="#"+e.selector+".oxy-social-icons a.oxy-social-icons-"+U+" svg {",n+="color: "+L+";",n+="}",n+="#"+e.selector+".oxy-social-icons a.oxy-social-icons-"+U+":hover svg {",n+="color: "+$+";",n+="}")}n+="#"+e.selector+".oxy-social-icons a svg {",n+="blank"!=K?"width: 0.5em; height: 0.5em;":"width: 1em; height: 1em;",n+="color: "+(ot.getGlobalColorValue(e.original["icon-color"])||c["icon-color"])+"; ",n+="}",n+="#"+e.selector+".oxy-social-icons a:hover svg {",n+="color: "+(ot.getGlobalColorValue(e.original["icon-hover-color"])||c["icon-hover-color"])+"; ",n+="}"}if("oxy_testimonial"==e.name){var Z,Q,q,R,J,ee="",te=S.testimonial_image_spacing;if("vertical"==S.testimonial_layout?(ee="margin:0;",te=S.testimonial_image_spacing||c.testimonial_image_spacing+c["testimonial_image_spacing-unit"],"bottom"==S.testimonial_image_position?ee+="margin-top":ee+="margin-bottom"):"bottom"==S.testimonial_image_position?(ee="margin:0;",te=S.testimonial_image_spacing||c.testimonial_image_spacing+c["testimonial_image_spacing-unit"],ee+="margin-left"):ee+="margin-right",ee+=": "+te+";","left"==S.testimonial_content_alignment?(Z="flex-start",Q="left"):"center"==S.testimonial_content_alignment?Q=Z="center":"right"==S.testimonial_content_alignment&&(Z="flex-end",Q="right"),"left"==e.original.testimonial_mobile_content_alignment?(q="flex-start",R="left"):"center"==e.original.testimonial_mobile_content_alignment?R=q="center":"right"==e.original.testimonial_mobile_content_alignment&&(q="flex-end",R="right"),"vertical"==S.testimonial_layout?n+="#"+e.selector+" {flex-direction: column;}":"horizontal"==S.testimonial_layout&&(n+="#"+e.selector+" {flex-direction: row;align-items: center;}"),"top"==S.testimonial_image_position?n+="#"+e.selector+" .oxy-testimonial-photo-wrap {order: 1;}":"bottom"==S.testimonial_image_position&&(n+="#"+e.selector+" .oxy-testimonial-photo-wrap {order: 3;}"),n+="#"+e.selector+" .oxy-testimonial-photo {width:"+S.testimonial_image_size+";height:"+S.testimonial_image_size+";"+ee+"}",n+="#"+e.selector+" .oxy-testimonial-photo-wrap,#"+e.selector+" .oxy-testimonial-author-wrap,#"+e.selector+" .oxy-testimonial-content-wrap {align-items:"+Z+";text-align:"+Q+";}",n+="#"+e.selector+" .oxy-testimonial-text {margin-bottom:"+S.testimonial_text_space_below+";"+ot.generateTypographyCSS(S,"testimonial_text_typography")+"}",n+="#"+e.selector+" .oxy-testimonial-author {margin-bottom:"+S.testimonial_author_space_below+";"+ot.generateTypographyCSS(S,"testimonial_author_typography")+"}",n+="#"+e.selector+" .oxy-testimonial-author-info {margin-bottom:"+S.testimonial_author_info_space_below+";"+ot.generateTypographyCSS(S,"testimonial_author_info_typography")+"}",maxSize=ot.getMediaMaxSize(e.original.testimonial_vertical_layout_below),maxSize)J="bottom"==S.testimonial_image_position?"top":"bottom",n+="@media (max-width: "+maxSize+"){#"+e.selector+" {flex-direction: column !important;}#"+e.selector+" .oxy-testimonial-photo {margin: 0;margin-"+J+":"+S.testimonial_image_spacing+";}#"+e.selector+" .oxy-testimonial-photo-wrap, #"+e.selector+" .oxy-testimonial-author-wrap, #"+e.selector+" .oxy-testimonial-content-wrap {align-items:"+q+";text-align:"+R+";}}"}if("oxy_icon_box"==e.name){var oe,re,ae,ie,ne;if("top"==S.icon_box_icon_position?oe="column":"left"==S.icon_box_icon_position?oe="row":"right"==S.icon_box_icon_position?oe="row-reverse":"bottom"==S.icon_box_icon_position&&(oe="column-reverse"),"left"==S.icon_box_icon_position||"right"==S.icon_box_icon_position){var se=S.icon_box_icon_space_before||c.icon_box_icon_space_before+c["icon_box_icon_space_before-unit"];right=S.icon_box_icon_space_after||c.icon_box_icon_space_after+c["icon_box_icon_space_after-unit"],ae="margin-left: "+se+";\n",ae+="margin-right: "+right+";\n",ae+="margin-bottom: 0; margin-top: 0;"}else ae="margin-top: "+S.icon_box_icon_space_before+";\n",ae+="margin-bottom: "+S.icon_box_icon_space_after+";\n";"left"==S.icon_box_icon_position||"right"==S.icon_box_icon_position?re=S.icon_box_icon_vertical_alignment:"left"==S.icon_box_content_alignment?re="flex-start":"center"==S.icon_box_content_alignment?re="center":"right"==S.icon_box_content_alignment&&(re="flex-end"),ne="left"==S.icon_box_mobile_content_alignment?(ie="flex-start","left"):"center"==S.icon_box_mobile_content_alignment?ie="center":"right"==S.icon_box_mobile_content_alignment?(ie="flex-end","right"):(ie="flex-start","left"),n+="#"+e.selector+" {text-align: "+S.icon_box_content_alignment+";flex-direction: "+oe+";}",n+="#"+e.selector+" .oxy-icon-box-icon {"+ae+"align-self: "+re+";}",n+="#"+e.selector+" .oxy-icon-box-heading {"+ot.generateTypographyCSS(S,"icon_box_heading_typography")+"margin-top: "+S.icon_box_heading_space_above+";margin-bottom: "+S.icon_box_heading_space_below+";}",n+="#"+e.selector+" .oxy-icon-box-text {"+ot.generateTypographyCSS(S,"icon_box_text_typography")+"margin-top: "+S.icon_box_text_space_above+";margin-bottom: "+S.icon_box_text_space_below+";align-self: "+re+";}",n+="#"+e.selector+" .oxy-icon-box-link {margin-top: "+S.icon_box_link_space_above+";margin-bottom: "+S.icon_box_link_space_below+";}",maxSize=ot.getMediaMaxSize(S.icon_box_vertical_layout_below),maxSize&&!t&&(n+="@media (max-width: "+maxSize+"){#"+e.selector+".oxy-icon-box {flex-direction: column !important;text-align: "+ne+";}#"+e.selector+" .oxy-icon-box-icon {margin-left: 0;margin-right: 0;margin-top: "+S.icon_box_icon_space_before+";margin-bottom: "+S.icon_box_icon_space_after+";}#"+e.selector+" .oxy-icon-box-icon, .oxy-icon-box-text {align-self: "+ie+";}}")}if("oxy_pricing_box"==e.name)"vertical"==S.pricing_box_price_layout?(u="column","left"==S.pricing_box_price_alignment?m="flex-start":"center"==S.pricing_box_price_alignment?m="center":"right"==S.pricing_box_price_alignment&&(m="flex-end")):"horizontal"==S.pricing_box_price_layout&&(u="row"),"horizontal"==S.pricing_box_price_layout&&("left"==S.pricing_box_price_alignment?_="flex-start":"center"==S.pricing_box_price_alignment?_="center":"right"==S.pricing_box_price_alignment&&(_="flex-end")),"left"==S.pricing_box_global_alignment?y="flex-start":"center"==S.pricing_box_global_alignment?y="center":"right"==S.pricing_box_global_alignment&&(y="flex-end"),"left"==S.pricing_box_graphic_alignment?h="flex-start":"center"==S.pricing_box_graphic_alignment?h="center":"right"==S.pricing_box_graphic_alignment?h="flex-end":y&&(iamge_justify_content=y),"left"==S.pricing_box_cta_alignment?b="flex-start":"center"==S.pricing_box_cta_alignment?b="center":"right"==S.pricing_box_cta_alignment?b="flex-end":y&&(b=y),n+="#"+e.selector+" .oxy-pricing-box-section {"+ot.generateArrayOptionsCSS(S,"pricing_box_global")+"text-align:"+S.pricing_box_global_alignment+";}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-price {justify-content:"+y+";}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-graphic {"+ot.generateArrayOptionsCSS(S,"pricing_box_graphic")+"background-color:"+ot.getGlobalColorValue(S.pricing_box_graphic_background)+";text-align:"+S.pricing_box_graphic_alignment+";justify-content:"+h+";}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-title {"+ot.generateArrayOptionsCSS(S,"pricing_box_title")+"text-align:"+S.pricing_box_title_alignment+";background-color:"+ot.getGlobalColorValue(S.pricing_box_title_background)+";}",n+="#"+e.selector+" .oxy-pricing-box-title-title {"+ot.generateTypographyCSS(S,"pricing_box_title_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-title-subtitle {"+ot.generateTypographyCSS(S,"pricing_box_subtitle_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-price {"+ot.generateArrayOptionsCSS(S,"pricing_box_price")+"text-align:"+S.pricing_box_price_alignment+";background-color:"+ot.getGlobalColorValue(S.pricing_box_price_background)+";flex-direction:"+u+";justify-content:"+_+";align-items:"+m+";}",n+="#"+e.selector+" .oxy-pricing-box-currency {"+ot.generateTypographyCSS(S,"pricing_box_price_amount_currency_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-amount-main {"+ot.generateTypographyCSS(S,"pricing_box_price_amount_main_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-amount-decimal {"+ot.generateTypographyCSS(S,"pricing_box_price_amount_decimal_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-term {"+ot.generateTypographyCSS(S,"pricing_box_price_amount_term_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-sale-price {"+ot.generateTypographyCSS(S,"pricing_box_price_sale_typography")+"margin-bottom:"+S.pricing_box_price_sale_space_below+";}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-content {background-color:"+ot.getGlobalColorValue(S.pricing_box_content_background)+";text-align:"+S.pricing_box_content_alignment+";"+ot.generateTypographyCSS(S,"pricing_box_content_typography")+"}",n+="#"+e.selector+" .oxy-pricing-box-section.oxy-pricing-box-cta {"+ot.generateArrayOptionsCSS(S,"pricing_box_cta")+"background-color:"+ot.getGlobalColorValue(S.pricing_box_cta_background)+";text-align:"+S.pricing_box_cta_alignment+";justify-content:"+b+";}";if("oxy_progress_bar"==e.name){var le="",ce=[];if("true"==S.progress_bar_stripes&&(le="background-image: linear-gradient(-45deg,rgba(255,255,255,.12) 25%,transparent 25%,transparent 50%,rgba(255,255,255,.12) 50%,rgba(255,255,255,.12) 75%,transparent 75%,transparent);"),"false"==S.progress_bar_stripes&&(le="background-image:none;"),"true"==S.progress_bar_animation_stripes){var pe=S.progress_bar_animation_stripes_duration||c.progress_bar_animation_stripes_duration;ce.stripes="oxy_progress_bar_stripes "+pe+" linear infinite"}if("false"==S.progress_bar_animation_stripes&&(ce.stripes="none 0s paused"),"true"==S.progress_bar_animate_width){var de=S.progress_bar_animation_width_duration||c.progress_bar_animation_width_duration;ce.width="oxy_progress_bar_width "+de+" ease-out 1"}"false"==S.progress_bar_animate_width&&(ce.width="none 0s paused");var ge=[];for(var Y in ce)ge.push(ce[Y]);n+="#"+e.selector+l+" .oxy-progress-bar-background {background-color:"+ot.getGlobalColorValue(S.progress_bar_background_color)+";"+le,ce.stripes&&(n+="animation:"+ce.stripes+";"),n+="}",n+="#"+e.selector+l+" .oxy-progress-bar-progress-wrap {width:"+S.progress_bar_progress+";}",n+="#"+e.selector+l+" .oxy-progress-bar-progress {background-color:"+ot.getGlobalColorValue(S.progress_bar_bar_color)+";padding:"+S.progress_bar_bar_padding+";"+le+"animation:"+ge.join()+";}",n+="#"+e.selector+l+" .oxy-progress-bar-overlay-text {"+ot.generateTypographyCSS(S,"progress_bar_left_text_typography")+"}",n+="#"+e.selector+l+" .oxy-progress-bar-overlay-percent {"+ot.generateTypographyCSS(S,"progress_bar_right_text_typography")+"}"}if("oxy_toggle"==e.name&&(n+="#"+e.selector+l+" .oxy-expand-collapse-icon {font-size:"+S.toggle_icon_size+";}",n+="#"+e.selector+l+" .oxy-expand-collapse-icon::before,#"+e.selector+l+" .oxy-expand-collapse-icon::after {background-color:"+ot.getGlobalColorValue(S.toggle_icon_color)+";}"),"oxy_superbox"==e.name){var me,ue,_e,ye,he,be=S.superbox_secondary_scale_start,xe=S.superbox_secondary_scale_finish,Se=S.superbox_primary_scale_start,fe=S.superbox_primary_scale_finish,ve="",Ce="",we="",ke="",Pe=":hover";"as_hovered"==e.original.superbox_editing_mode&&(Pe=""),void 0!==be&&(ue="transform: scale("+be+");"),void 0!==xe&&(_e="transform: scale("+xe+");"),void 0!==Se&&(ye="transform: scale("+Se+");"),void 0!==fe&&(he="transform: scale("+fe+");"),S.superbox_secondary_slide_direction&&(me=ot.slide_position(S.superbox_secondary_slide_direction,(S.superbox_secondary_slide_distance||"")+"px"),"in"==S.superbox_secondary_slide_inorout?(ve=me.out_css,Ce=me.in_css):"out"==S.superbox_secondary_slide_inorout&&(ve=me.in_css,Ce=me.out_css)),S.superbox_primary_slide_direction&&(me=ot.slide_position(S.superbox_primary_slide_direction,(S.superbox_primary_slide_distance||"")+"px"),"in"==S.superbox_primary_slide_inorout?(we=me.out_css,ke=me.in_css):"out"==S.superbox_primary_slide_inorout&&(we=me.in_css,ke=me.out_css));var Oe=S.superbox_transition_duration;n+="#"+e.selector+" .oxy-superbox-secondary, #"+e.selector+" .oxy-superbox-primary {transition-duration:"+Oe+";}",n+="#"+e.selector+" .oxy-superbox-secondary {opacity:"+S.superbox_secondary_opacity_start+";"+ve+ue+"}","as_not_hovered"!==e.original.superbox_editing_mode&&(n+="#"+e.selector+Pe+" .oxy-superbox-secondary {opacity:"+S.superbox_secondary_opacity_finish+";z-index: 2147483642;"+Ce+_e+"}"),n+="#"+e.selector+" .oxy-superbox-primary {opacity:"+S.superbox_primary_opacity_start+";"+we+ye+"}","as_not_hovered"!==e.original.superbox_editing_mode&&(n+="#"+e.selector+Pe+" .oxy-superbox-primary {opacity:"+S.superbox_primary_opacity_finish+";"+ke+he+"}")}if("oxy_nav_menu"==e.name){oxyNavMenuStyle="#"+e.selector+" .oxy-nav-menu-list"+l+"{",oxyNavMenuStyleItem="#"+e.selector+" .menu-item"+l+" a {",oxyNavMenuStyleActive="#"+e.selector+" .current-menu-item a"+l+"{",oxyNavMenuStyleDropdowns="#"+e.selector+".oxy-nav-menu:not(.oxy-nav-menu-open) .sub-menu"+l+"{",oxyNavMenuStyleDropdownsItem="#"+e.selector+".oxy-nav-menu:not(.oxy-nav-menu-open) .sub-menu .menu-item a"+l+"{",oxyNavMenuStyleNotOpenItem="#"+e.selector+".oxy-nav-menu:not(.oxy-nav-menu-open) .menu-item a"+l+"{",oxyNavMenuStyleDropdownsItemHover="#"+e.selector+".oxy-nav-menu:not(.oxy-nav-menu-open) .oxy-nav-menu-list .sub-menu .menu-item a:hover{",e.original["menu_dropdowns_background-color"]||(oxyNavMenuStyleDropdowns+="background-color:"+ot.getGlobalColorValue(e.original["menu_hover_background-color"])+";"),oxyNavMenuStyleDropdownsItem+="border: 0;","row"==e.original["menu_flex-direction"]?(oxyNavMenuStyleDropdownsItem+="padding-top:"+e.original["menu_padding-top"]+"px;",oxyNavMenuStyleDropdownsItem+="padding-bottom:"+e.original["menu_padding-bottom"]+"px;"):(oxyNavMenuStyleDropdownsItem+="padding-left:"+e.original["menu_padding-top"]+"px;",oxyNavMenuStyleDropdownsItem+="padding-rigth:"+e.original["menu_padding-bottom"]+"px;"),e.original["menu_justify-content"]&&(oxyNavMenuStyleNotOpenItem+="justify-content:"+e.original["menu_justify-content"]+";"),"never"!=e.original.menu_responsive&&("always"!=e.original.menu_responsive&&(n+="@media (max-width: "+ot.getMediaMaxSize(e.original.menu_responsive)+") {"),n+="#"+e.selector+" .oxy-nav-menu-list {display: none;}",n+="#"+e.selector+" .oxy-menu-toggle {display: initial;}",n+="#"+e.selector+".oxy-nav-menu.oxy-nav-menu-open .oxy-nav-menu-list {display: initial;}","always"!=e.original.menu_responsive&&(n+="}"));var ze=parseInt(e.original.menu_responsive_icon_size||40),Te=parseInt(e.original.menu_responsive_icon_size||40)+2*parseInt(e.original.menu_responsive_padding_size||0),Ge=parseInt(.8*ze),Me=parseInt(.15*ze),Ve=Ge/2-Me/2;t||"id"!=p||(n+="#"+e.selector+".oxy-nav-menu.oxy-nav-menu-open {background-color:"+ot.getGlobalColorValue(e.original.menu_responsive_background_color)+";margin-top: 0 !important;margin-right: 0 !important;margin-left: 0 !important;margin-bottom: 0 !important;} #"+e.selector+".oxy-nav-menu.oxy-nav-menu-open .menu-item a {color:"+ot.getGlobalColorValue(e.original.menu_responsive_link_color)+";padding-top:"+(e.original.menu_responsive_padding_top||e.original["menu_padding-top"])+"px;padding-right:"+(e.original.menu_responsive_padding_right||e.original["menu_padding-right"])+"px;padding-bottom:"+(e.original.menu_responsive_padding_bottom||e.original["menu_padding-bottom"])+"px;padding-left:"+(e.original.menu_responsive_padding_left||e.original["menu_padding-left"])+"px;} #"+e.selector+".oxy-nav-menu.oxy-nav-menu-open .menu-item a:hover {color:"+ot.getGlobalColorValue(e.original.menu_responsive_hover_link_color)+"} #"+e.selector+".oxy-nav-menu .menu-item a:hover {text-decoration:"+e.original["menu_text-decoration"]+"} #"+e.selector+" .oxy-nav-menu-hamburger-wrap {width:"+Te+"px;height:"+Te+"px;margin-top:"+e.original.menu_responsive_icon_margin+"px;margin-bottom:"+e.original.menu_responsive_icon_margin+"px;background-color:"+ot.getGlobalColorValue(e.original.menu_responsive_padding_color)+";} #"+e.selector+" .oxy-nav-menu-hamburger-wrap:hover {background-color:"+ot.getGlobalColorValue(e.original.menu_responsive_padding_hover_color)+";} #"+e.selector+" .oxy-nav-menu-hamburger {width:"+ze+"px;height:"+Ge+"px;} #"+e.selector+" .oxy-nav-menu-hamburger .oxy-nav-menu-hamburger-line {height:"+Me+"px;background-color:"+ot.getGlobalColorValue(e.original.menu_responsive_icon_color)+";} #"+e.selector+" .oxy-nav-menu-hamburger-wrap:hover  .oxy-nav-menu-hamburger-line {background-color:"+ot.getGlobalColorValue(e.original.menu_responsive_icon_hover_color)+";} #"+e.selector+".oxy-nav-menu-open .oxy-nav-menu-hamburger .oxy-nav-menu-hamburger-line:first-child {top:"+Ve+"px;} #"+e.selector+".oxy-nav-menu-open .oxy-nav-menu-hamburger .oxy-nav-menu-hamburger-line:last-child {top:-"+Ve+"px;}",n+="#"+e.selector+" .menu-item > .sub-menu {transition-duration:"+e.original["menu_transition-duration"]+"s; }")}if("oxy_nav_menu"==e.name&&e.original.menu_color&&(n+="#"+e.selector+" .oxy-nav-menu-hamburger-line{",n+="background-color:"+ot.getGlobalColorValue(e.original.menu_color)+";",n+="}"),"oxy_header"!=e.name&&"oxy_header_row"!=e.name||!e.original["background-color"]||(n+="#"+e.selector+" .oxy-nav-menu-open,",n+="#"+e.selector+" .oxy-nav-menu:not(.oxy-nav-menu-open) .sub-menu{",n+="background-color:"+ot.getGlobalColorValue(e.original["background-color"])+";",n+="}"),S["box-shadow-color"]){var Ae="inset"==S["box-shadow-inset"]?S["box-shadow-inset"]+" ":"",Ie=S["box-shadow-horizontal-offset"]?S["box-shadow-horizontal-offset"]+"px ":"",Ee=S["box-shadow-vertical-offset"]?S["box-shadow-vertical-offset"]+"px ":"",Fe=S["box-shadow-blur"]?S["box-shadow-blur"]+"px ":"0px ",Ne=S["box-shadow-spread"]?S["box-shadow-spread"]+"px ":"";S["box-shadow"]=Ae+Ie+Ee+Fe+Ne+ot.getGlobalColorValue(S["box-shadow-color"])}if(S["text-shadow-color"]){Ie=S["text-shadow-horizontal-offset"]?S["text-shadow-horizontal-offset"]+"px ":"",Ee=S["text-shadow-vertical-offset"]?S["text-shadow-vertical-offset"]+"px ":"",Fe=S["text-shadow-blur"]?S["text-shadow-blur"]+"px ":"0px ";S["text-shadow"]=Ie+Ee+Fe+ot.getGlobalColorValue(S["text-shadow-color"])}if(n+="#"+e.selector+s+l+"{",ot.component.options[o]&&ot.component.options[o].selector!==e.selector&&!e.original);else if("object"==typeof S)for(var je in n+=ot.getBackgroundLayersCSS(S,e.name,"id",o,r,p)||"",n+=ot.getTransformCSS(S)||"","ct_section"!=e.name&&"oxy_posts_grid"!=e.name&&(n+=ot.getGridCSS(S,e.name)||"","grid"==S["flex-direction"]&&(S.display="",S["flex-direction"]="")),S)if(!(0<=je.indexOf("hover_"))&&!(0<=je.indexOf("responsive"))&&!(0<=je.indexOf("slider"))&&!(0<=je.indexOf("icon"))&&!(0<=je.indexOf("soundcloud"))&&"background-size"!=je&&"background"!=je&&(S.hasOwnProperty(je)||x.hasOwnProperty(je))){if(ot.fixUnits&&t&&x.hasOwnProperty(je)&&-1==je.indexOf("-unit")){var Ke=je+"-unit",Be=x[je],De=x[Ke],He=ot.getClosestBreakpointValue(Ke,r,{id:o,state:p});if(Be&&!De&&He){var We=e.name+" [id:"+o+"]",Xe=ot.defaultOptions[e.name][Ke];-1<Ke.indexOf("container-padding")&&(Xe=ot.globalSettings.sections[Ke]),console.log(We+' has "'+je+'" with no unit on "'+r+'" breakpoint'),ot.findComponentItem(ot.componentsTree.children,o,function(e,t){t.options.media[r][p][Ke]=Xe,ot.applyComponentSavedOptions(o,t)}),console.log(We+' default "'+Xe+'" unit added for "'+Ke+'"'),console.log("-------------------------")}}var Ye=S[je];if("custom-css"==je)continue;if("ct_fancy_icon"==e.name&&("background"==je||"icon-background-color"==je||"icon-color"==je||"padding"==je||"icon-size"==je))continue;if(0<=["display","flex-direction","flex-wrap","align-items","align-content","justify-content","gap"].indexOf(je)&&"ct_section"==e.name)continue;if(("font-family"==je||-1<je.indexOf("font-family"))&&(ot.loadWebFont(Ye),-1===Ye.indexOf(",")&&"inherit"!==Ye.toLowerCase()&&(Ye="'"+Ye+"'")),Ye=ot.getGlobalColorValue(Ye),"content"==je.trim().toLowerCase()&&(Ye='"'+Ye.replace('"','\\"')+'"',ot.contentAdded["#"+e.selector+s+l]=!0),"flex-direction"==je){n+=je+":"+Ye+(v="reverse"==S["flex-reverse"]?"-reverse":"")+";";continue}if("filter"==je&&S["filter-amount-"+Ye])Ye+="("+S["filter-amount-"+Ye]+")";else if("filter"==je)continue;if("oxy_nav_menu"==e.name&&0===je.indexOf("menu_dropdowns_"))"menu_dropdowns_background-color"==je&&"hover"!==p?oxyNavMenuStyleDropdowns+=je.replace("menu_dropdowns_","")+":"+Ye+";":Ye&&ot.excludeProperties.indexOf(je)<0&&je&&(oxyNavMenuStyleDropdownsItem+=je.replace("menu_dropdowns_","")+":"+Ye+";"),0==je.indexOf("menu_dropdowns_padding")&&(oxyNavMenuStyleDropdownsItemHover+=je.replace("menu_dropdowns_","")+":"+Ye+";");else if("oxy_nav_menu"==e.name&&0===je.indexOf("menu_active_")){if("menu_active_border-bottom-width"==je&&void 0!==e.original["menu_padding-bottom"])Le=0<(Le=parseInt(e.original["menu_padding-bottom"])-parseInt(S["menu_active_border-bottom-width"]))?Le:0,oxyNavMenuStyleActive+="padding-bottom:"+Le+"px;";if("menu_active_border-top-width"==je&&void 0!==e.original["menu_padding-top"])Le=0<(Le=parseInt(e.original["menu_padding-top"])-parseInt(S["menu_active_border-top-width"]))?Le:0,oxyNavMenuStyleActive+="padding-top:"+Le+"px;";Ye&&ot.excludeProperties.indexOf(je)<0&&je&&(oxyNavMenuStyleActive+=je.replace("menu_active_","")+":"+Ye+";")}else if("oxy_nav_menu"==e.name&&0===je.indexOf("menu_")){if("menu_flex-direction"==je){oxyNavMenuStyle+="flex-direction:"+Ye;continue}if("menu_justify-content"==je||"menu_dropdown_arrow"==je)continue;if("menu_border-bottom-width"==je&&"hover"==p&&void 0!==e.original["menu_padding-bottom"]){if(Le=0<(Le=parseInt(e.original["menu_padding-bottom"])-parseInt(S["menu_border-bottom-width"]))?Le:0,"row"==e.original["menu_flex-direction"])var Ue="padding-bottom:";else{Ue="padding-right:";je="border-right-width"}oxyNavMenuStyleItem+=Ue+Le+"px;"}if("menu_border-top-width"==je&&"hover"==p&&void 0!==e.original["menu_padding-top"]){var Le;if(Le=0<(Le=parseInt(e.original["menu_padding-top"])-parseInt(S["menu_border-top-width"]))?Le:0,"row"==e.original["menu_flex-direction"])Ue="padding-top:";else{Ue="padding-left:";je="border-left-width"}oxyNavMenuStyleItem+=Ue+Le+"px;"}"menu_-webkit-font-smoothing"==je&&(oxyNavMenuStyleItem+="-moz-osx-font-smoothing:"+("antialiased"===Ye?"grayscale":"unset")+";"),"menu_transition-duration"==je&&(Ye+="s"),Ye&&ot.excludeProperties.indexOf(je)<0&&je&&(oxyNavMenuStyleItem+=je.replace("menu_","")+":"+Ye+";")}else{if("background-image"==je)continue;Ye&&ot.excludeProperties.indexOf(je)<0&&"background-layers"!==je&&(void 0===ot.notCSSOptions[e.name]||ot.notCSSOptions[e.name].indexOf(je.replace(/-/g,"_"))<0)&&(n+=je+":"+Ye+";"),"-webkit-font-smoothing"==je&&(n+="-moz-osx-font-smoothing:"+("antialiased"===Ye?"grayscale":"unset")+";")}}"before"!=p&&"after"!=p||ot.contentAdded["#"+e.selector+s+l]||(n+='content:"";',ot.contentAdded["#"+e.selector+s+l]=!0),S["custom-css"]&&(n+=ot.replaceGlobalColors(S["custom-css"])),n+="}","oxy_nav_menu"==e.name&&(n+=oxyNavMenuStyle+"}"+oxyNavMenuStyleItem+"}"+oxyNavMenuStyleActive+"}"+oxyNavMenuStyleDropdowns+"}"+oxyNavMenuStyleNotOpenItem+"}"+oxyNavMenuStyleDropdownsItem+"}"+oxyNavMenuStyleDropdownsItemHover+"}")}if(void 0!==ot.componentsTemplates&&ot.componentsTemplates[e.name]&&ot.componentsTemplates[e.name].pageCSS&&!0!==ot.APIElementsDefaultCSS[e.name]){var $e=ot.componentsTemplates[e.name].pageCSS;$e=ot.replaceGlobalWooSettings($e),ot.APIElementsDefaultCSS[e.name]=!0,n+=$e}if(void 0!==ot.componentsTemplates&&ot.componentsTemplates[e.name]&&ot.componentsTemplates[e.name].registeredSelectors&&(n+=ot.generateAPISelectorsCSS(e.name,e.selector,S)),S&&void 0!==ot.componentsTemplates&&ot.componentsTemplates[e.name]){var Ze=ot.componentsTemplates[e.name].valuesCSS;for(var Qe in Ze)if(Ze.hasOwnProperty(Qe)&&Ze[Qe][S[Qe]]){var qe=Ze[Qe][S[Qe]];n+=ot.prefixCSSSelectors(qe,e.selector)}}}if(n+=ot.getMappedCSS(e.selector,e.original),e.media){var Re=angular.copy(e.media),Je=ot.sortedMediaList();for(var et in Je){var tt=Je[et];Re[tt]&&(Re[tt].name=e.name,Re[tt].selector=e.selector,n+="@media (max-width: "+ot.mediaList[tt].maxSize+") {",n+=ot.getSingleComponentCSS(Re[tt],o,!0,tt,a),n+="}")}}return ot.functionEnd("getSingleComponentCSS()"),n},ot.prefixCSSSelectors=function(e,t,o){if(void 0===e||void 0===t)return e;var r=e.split("}");for(var a in r)if(r.hasOwnProperty(a)){var i=r[a],n=i.split("{");if(3==i.split("{").length){var s=n[0]+"{";n[0]=n[1];var l=!0}var c=n[0].split(",");for(var p in c)c[p]=(o?".":"#")+t+" "+c[p];3==i.split("{").length?r[a]=s+"\n"+c.join(", ")+"{"+n[2]:i[0]&&0!==i[0].length||!l?n[1]&&(r[a]=c.join(", ")+"{"+n[1]):(l=!1,r[a]=c.join(", ")+"{"+n[2]+"}\n")}return e=r.join("}\n")},ot.getGridCSS=function(e,t,o){var r="";if(null==t&&(t="all"),e.display&&"grid"==e.display||e["flex-direction"]&&"grid"==e["flex-direction"]){o&&(r+="display: grid !important;");var a=e["grid-column-count"]?e["grid-column-count"]:ot.defaultOptions[t]["grid-column-count"]||ot.defaultOptions.all["grid-column-count"],i=e["grid-column-min-width"]?e["grid-column-min-width"]:ot.defaultOptions[t]["grid-column-min-width"],n=e["grid-column-min-width"]?"":ot.defaultOptions[t]["grid-column-min-width-unit"],s=e["grid-column-max-width"]?e["grid-column-max-width"]:ot.defaultOptions[t]["grid-column-max-width"];max_width_unit=e["grid-column-max-width"]?"":ot.defaultOptions[t]["grid-column-max-width-unit"],"true"==e["grid-columns-auto-fit"]&&(a="auto-fit"),e["grid-justify-items"]?r+="justify-items: "+e["grid-justify-items"]+";":r+="justify-items: stretch;",e["grid-align-items"]&&(r+="align-items: "+e["grid-align-items"]+";"),void 0!==a&&void 0!==i&&void 0!==s&&(r+="grid-template-columns: repeat("+a+", minmax("+i+n+", "+s+max_width_unit+"));");var l=e["grid-column-gap"]?e["grid-column-gap"]:ot.defaultOptions[t]["grid-column-gap"];if(gap_unit=e["grid-column-gap"]?"":ot.defaultOptions[t]["grid-column-gap-unit"],r+="grid-column-gap: "+l+gap_unit+";",e["grid-row-behavior"]&&"Explicit"==e["grid-row-behavior"]){var c=e["grid-row-count"]?e["grid-row-count"]:ot.defaultOptions[t]["grid-row-count"],p=e["grid-row-min-height"]?e["grid-row-min-height"]:ot.defaultOptions[t]["grid-row-min-height"],d=e["grid-row-min-height"]?"":ot.defaultOptions[t]["grid-row-min-height-unit"],g=e["grid-row-max-height"]?e["grid-row-max-height"]:ot.defaultOptions[t]["grid-row-max-height"];max_height_unit=e["grid-row-max-height"]?"":ot.defaultOptions[t]["grid-row-max-height-unit"],null!=c&&null!=p&&null!=g&&(r+="grid-template-rows: repeat("+c+", minmax("+p+d+", "+g+max_height_unit+"));")}l=e["grid-row-gap"]?e["grid-row-gap"]:ot.defaultOptions[t]["grid-row-gap"],gap_unit=e["grid-row-gap"]?"":ot.defaultOptions[t]["grid-row-gap-unit"],r+="grid-row-gap: "+l+gap_unit+";","true"==e["grid-match-height-of-tallest-child"]&&(r+="grid-auto-rows: minmax(min-content,1fr);")}return r},ot.getGridChildCSS=function(e,t,o,r,a,i,n){var s="";if(void 0===r&&(r=""),(e["flex-direction"]&&"grid"==e["flex-direction"]||e.display&&"grid"==e.display)&&e["grid-all-children-rule"]&&(s+=ot.getGridSingleChildCSS(e["grid-all-children-rule"],"*",t,o,r,a)),(e["flex-direction"]&&"grid"==e["flex-direction"]||e.display&&"grid"==e.display)&&e["grid-child-rules"])for(var l in e["grid-child-rules"]){var c="",p=e["grid-child-rules"][l];if(p&&void 0!==p["child-index"]){var d=parseInt(p["child-index"]);if(i&&1<d?d++:!n&&"true"==e.grid&&d&&(d+=3),c+=p["column-span"]?"grid-column: span "+p["column-span"]+";":"",c+=p["row-span"]?"grid-row: span "+p["row-span"]+";":"",p["row-span"]&&1!=p["row-span"]&&(c+="height: 100%;"),""==c)continue;var g=0==d?":last-child":":nth-child("+d+")";a?o&&"original"!=o?(s+="."+t+":not(.ct-section):not(.oxy-easy-posts):"+o+",\r\n",ot.isPseudoElement(o)?(s+="."+t+".ct-section .ct-section-inner-wrap:"+o+" > "+g+",\r\n",s+="."+t+".oxy-easy-posts .oxy-posts:"+o+" > "+g+"{\r\n"):(s+="."+t+".ct-section:"+o+" .ct-section-inner-wrap > "+g+",\r\n",s+="."+t+".oxy-easy-posts:"+o+" .oxy-posts > "+g+"{\r\n")):(s+="."+t+":not(.ct-section):not(.oxy-easy-posts) > "+g+",\r\n",s+="."+t+".ct-section .ct-section-inner-wrap > "+g+",\r\n",s+="."+t+".oxy-easy-posts .oxy-posts > "+g+"{\r\n"):s+=o&&"original"!=o?"#"+t+" "+r+":"+o+"> "+g+"{\r\n":"#"+t+" "+r+"> "+g+"{\r\n",s+=c,s+="}\r\n"}}return s},ot.getGridSingleChildCSS=function(e,t,o,r,a,i){var n="";return pre_styles=e["column-span"]?"grid-column: span "+e["column-span"]+";":"",pre_styles+=e["row-span"]?"grid-row: span "+e["row-span"]+";":"",e["row-span"]&&1!=e["row-span"]&&(pre_styles+="height: 100%;"),""!=pre_styles&&(i?r&&"original"!=r?(n+="."+o+":not(.ct-section):not(.oxy-easy-posts):"+r+",\r\n",ot.isPseudoElement(r)?(n+="."+o+".ct-section .ct-section-inner-wrap:"+r+" > "+t+",\r\n",n+="."+o+".oxy-easy-posts .oxy-posts:"+r+" > "+t+"{\r\n"):(n+="."+o+".ct-section:"+r+" .ct-section-inner-wrap > "+t+",\r\n",n+="."+o+".oxy-easy-posts:"+r+" .oxy-posts > "+t+"{\r\n")):(n+="."+o+":not(.ct-section):not(.oxy-easy-posts) > "+t+",\r\n",n+="."+o+".ct-section .ct-section-inner-wrap > "+t+",\r\n",n+="."+o+".oxy-easy-posts .oxy-posts > "+t+"{\r\n"):n+=r&&"original"!=r?"#"+o+" "+a+":"+r+"> "+t+"{\r\n":"#"+o+" "+a+"> "+t+"{\r\n",n+=pre_styles,n+="}\r\n"),n},ot.getTransformCSS=function(e){if(e.transform){var t=ot.objectToArrayObject(e.transform),o="";for(var r in t)if(t.hasOwnProperty(r)){var a=t[r];"skew"==a["transform-type"]&&(a.skewX&&a.skewY?o+=a["transform-type"]+"("+a.skewX+"deg,"+a.skewY+"deg)":a.skewX&&(o+=a["transform-type"]+"("+a.skewX+"deg)")),"translate"==a["transform-type"]&&(a.translateX&&a.translateY&&a.translateZ?o+="translate3d("+a.translateX+(a["translateX-unit"]||ot.defaultOptions.all["translateX-unit"])+","+a.translateY+(a["translateY-unit"]||ot.defaultOptions.all["translateY-unit"])+","+a.translateZ+(a["translateZ-unit"]||ot.defaultOptions.all["translateZ-unit"])+")":a.translateX&&a.translateY?o+=a["transform-type"]+"("+a.translateX+(a["translateX-unit"]||ot.defaultOptions.all["translateX-unit"])+","+a.translateY+(a["translateY-unit"]||ot.defaultOptions.all["translateY-unit"])+")":a.translateX?o+=a["transform-type"]+"("+a.translateX+(a["translateX-unit"]||ot.defaultOptions.all["translateX-unit"])+")":a.translateY&&(o+="translateY("+a.translateY+(a["translateY-unit"]||ot.defaultOptions.all["translateY-unit"])+")")),"rotate"==a["transform-type"]&&a.rotateAngle&&(o+=a["transform-type"]+"("+a.rotateAngle+"deg)"),"rotateX"==a["transform-type"]&&a.rotateXAngle&&(o+=a["transform-type"]+"("+a.rotateXAngle+"deg)"),"rotateY"==a["transform-type"]&&a.rotateYAngle&&(o+=a["transform-type"]+"("+a.rotateYAngle+"deg)"),"perspective"==a["transform-type"]&&a.perspective&&(o+=a["transform-type"]+"("+a.perspective+(a["perspective-unit"]||ot.defaultOptions.all["perspective-unit"])+")"),"rotate3d"==a["transform-type"]&&a.rotate3dX&&a.rotate3dY&&a.rotate3dZ&&a.rotate3dAngle&&(o+=a["transform-type"]+"("+a.rotate3dX+","+a.rotate3dY+","+a.rotate3dZ+","+a.rotate3dAngle+"deg)"),"scale"==a["transform-type"]&&(a.scaleX&&a.scaleY&&a.scaleZ?o+="scale3d("+a.scaleX+","+a.scaleY+","+a.scaleZ+")":a.scaleX&&a.scaleY?o+=a["transform-type"]+"("+a.scaleX+","+a.scaleY+")":(a.scaleX&&(o+=" scaleX("+a.scaleX+")"),a.scaleY&&(o+=" scaleY("+a.scaleY+")"),a.scaleZ&&(o+=" scaleZ("+a.scaleZ+")"))),r<t.length-1?o+=" ":o+=";"}return""!==o&&(o="transform:"+o),o}},ot.getBackgroundLayersCSS=function(e,t,o,r,a,i){ot.getGlobalColorValue(e["background-color"]);var n=[],s=[],l=[];e.gradient&&e.gradient.colors&&(l=e.gradient.colors);var c="";if(l=_.map(l,function(e){return e}),l=_.filter(l,function(e){return e.value}),0<(l=_.map(l,function(e){return e.value=ot.getGlobalColorValue(e.value),e})).length){if("radial"===e.gradient["gradient-type"]){c+=" radial-gradient(";var p="";e.gradient["radial-shape"]&&(p+=" "+e.gradient["radial-shape"]),e.gradient["radial-size"]&&(p+=" "+e.gradient["radial-size"]),e.gradient["radial-position-left"]&&(p+=" at "+e.gradient["radial-position-left"]+(e.gradient["radial-position-left-unit"]||"px"),e.gradient["radial-position-top"]&&(p+=" "+e.gradient["radial-position-top"]+(e.gradient["radial-position-top-unit"]||"px"))),0<p.length&&(c+=p+", ")}else c+=" linear-gradient(",e.gradient["linear-angle"]&&(c+=e.gradient["linear-angle"]+"deg, ");if(l){var d=_.filter(l,function(e){return e.value&&0<e.value.length}),g=_.map(d,function(e){return e.value+(e.position?" "+e.position+e["position-unit"]:"")});1===g.length&&g.push(g[0]),c+=g.join(", ")}0<(c+=")").length&&(n.push(c),s.push("auto"))}if(e["overlay-color"]&&(n.push("linear-gradient("+ot.getGlobalColorValue(e["overlay-color"])+", "+ot.getGlobalColorValue(e["overlay-color"])+")"),s.push("auto")),e["background-size"]&&0<e["background-size"].trim().length?(c="","manual"===e["background-size"]?(e["background-size-width"]&&0<e["background-size-width"].trim().length?c+=" "+e["background-size-width"].trim()+e["background-size-width-unit"].trim():c+=" 0%",e["background-size-height"]&&0<e["background-size-height"].trim().length?c+=" "+e["background-size-height"].trim()+e["background-size-height-unit"].trim():c+=" 0%"):c+=" "+e["background-size"],0<c.length&&s.push(c)):s=[],e.background&&n.push("url("+e.background+")"),e["background-image"]){var m=e["background-image"];-1<m.indexOf("[")&&ot.dynamicBackgrounds&&(m=ot.getDynamicBackground(o?"id"===o?"id":"selector":"class",{id:r,media:a,stateName:i})),n.push("url("+m+")")}var u=n.join(", ").trim(),y="";return""!==u&&(y="background-image:"+u+";"),0<s.length&&(y+="background-size:"+s.join(", ")+";"),y},ot.generateTypographyCSS=function(e,t){var o="";for(var r in e)if(-1<r.indexOf(t)){var a=r.replace(t+"_",""),i=e[r];"color"==a&&(i=ot.getGlobalColorValue(i)),o+=a+":"+ot.addFontFamilyQuotes(a,i)+";"}return o},ot.addFontFamilyQuotes=function(e,t){return("font-family"==e||-1<e.indexOf("font-family"))&&(ot.loadWebFont(t),-1===t.indexOf(",")&&"inherit"!==t.toLowerCase()&&(t="'"+t+"'")),t},ot.generateBoxShadowCSS=function(e,t){return null!=t?t+="_":t="",e[t+"box-shadow-color"]?"box-shadow:"+("inset"==e[t+"box-shadow-inset"]?e[t+"box-shadow-inset"]+" ":"")+(e[t+"box-shadow-horizontal-offset"]?e[t+"box-shadow-horizontal-offset"]+" ":"")+(e[t+"box-shadow-vertical-offset"]?e[t+"box-shadow-vertical-offset"]+" ":"")+(e[t+"box-shadow-blur"]?e[t+"box-shadow-blur"]+" ":"0px ")+(e[t+"box-shadow-spread"]?e[t+"box-shadow-spread"]+" ":"")+ot.getGlobalColorValue(e[t+"box-shadow-color"])+";":""},ot.generateArrayOptionsCSS=function(e,t){var o="";for(var r in e)-1<r.indexOf(t)&&(o+=r.replace(t+"_","")+":"+e[r]+";");return o},ot.getSingleClassCSS=function(e,t){ot.log&&(console.log("getSingleClassCSS()",e),ot.functionStart("getSingleClassCSS()")),void 0===t&&(t=ot.classes[e]),ot.contentAdded=[];var o=ot.getSelectorStyles(e,t);if(ot.classes[e].media){var r=ot.sortedMediaList(!1,!0);for(var a in r){var i=r[a];if(ot.classes[e].media[i]){if("page-width"==i)var n=ot.getPageWidth("global")+"px";else n=ot.mediaList[i].maxSize;t=ot.classes[e].media[i],o+="@media (max-width: "+n+") {",o+=ot.getSelectorStyles(e,t,!1,i),o+="}"}}}return ot.functionEnd("getSingleClassCSS()"),o},ot.getSingleSelectorCSS=function(e,t){ot.log&&(console.log("getSingleSelectorCSS()",e),ot.functionStart("getSingleSelectorCSS()")),void 0===t&&(t=ot.customSelectors[e]),ot.contentAdded=[];var o=ot.getSelectorStyles(e,t,!0);if(ot.customSelectors[e].media){var r=ot.sortedMediaList();for(var a in r){var i=r[a];ot.customSelectors[e].media[i]&&(t=ot.customSelectors[e].media[i],o+="@media (max-width: "+ot.mediaList[i].maxSize+") {",o+=ot.getSelectorStyles(e,t,!0,i),o+="}")}}return ot.functionEnd("getSingleSelectorCSS()"),o},ot.getSelectorStyles=function(e,t,o,r){if(""===e||!o&&void 0===ot.classes[e]||o&&void 0===ot.customSelectors[e])return"";var a,i="";for(var n in t)if(t.hasOwnProperty(n)){var s=t[n];if("media"==n||"set_name"==n||"key"==n||"parent"==n||"status"==n||"friendly_name"==n)continue;a=("original"==n||e==ot.selectorToEdit&&n==ot.currentState||e==ot.currentClass&&n==ot.currentState)&&("original"==n||"hover"==n||"active"==n||"focus"==n)?"":":"+n;var l={state:n};o?l.selector=e:l.class=e;var c=ot.getCSSOptions(null,null,s,null,r,l);if(i+=ot.generateAllAPISelectorsCSS(e,c,"class"),(void 0!==c["icon-style"]||void 0!==c["icon-color"]||void 0!==c["icon-background-color"]||void 0!==c["icon-padding"]||void 0!==c["icon-size"])&&!o){if(r||"original"!=n)p=ot.classes[e].original["icon-style"]||ot.defaultOptions.ct_fancy_icon["icon-style"],d=ot.getGlobalColorValue(c["icon-color"]),g=ot.getGlobalColorValue(c["icon-background-color"]),m=c["icon-padding"],u=c["icon-size"];else var p=c["icon-style"]||ot.defaultOptions.ct_fancy_icon["icon-style"],d=ot.getGlobalColorValue(c["icon-color"])||ot.defaultOptions.ct_fancy_icon["icon-color"],g=ot.getGlobalColorValue(c["icon-background-color"])||ot.defaultOptions.ct_fancy_icon["icon-background-color"],m=c["icon-padding"]||ot.defaultOptions.ct_fancy_icon["icon-padding"]+ot.defaultOptions.ct_fancy_icon["icon-padding-unit"],u=c["icon-size"]||ot.defaultOptions.ct_fancy_icon["icon-size"]+ot.defaultOptions.ct_fancy_icon["icon-size-unit"];i+="."+e+a+"{",1==p&&(i+="border: 1px solid;"),2==p&&g&&(i+="background-color: "+ot.getGlobalColorValue(g)+";",i+="border: 1px solid "+ot.getGlobalColorValue(g)+";"),1!=p&&2!=p||(i+="padding:"+m+";"),d&&(i+="color:"+ot.getGlobalColorValue(d)+";"),i+="}",u&&(i+="."+e+a+">svg {",i+="width: "+u+";",i+="height: "+u+";",i+="}")}if((void 0!==c["button-style"]||void 0!==c["button-color"]||void 0!==c["button-size"]||void 0!==c["button-text-color"])&&!o){if(r||"original"!=n)_=ot.classes[e].original["button-style"]||ot.defaultOptions.ct_link_button["button-style"],y=ot.getGlobalColorValue(c["button-color"]),h=c["button-size"],b=ot.getGlobalColorValue(c["button-text-color"]);else var _=c["button-style"]||ot.defaultOptions.ct_link_button["button-style"],y=ot.getGlobalColorValue(c["button-color"])||ot.defaultOptions.ct_link_button["button-color"],h=c["button-size"]||ot.defaultOptions.ct_link_button["button-size"]+ot.defaultOptions.ct_link_button["button-size-unit"],b=ot.getGlobalColorValue(c["button-text-color"])||ot.defaultOptions.ct_link_button["button-text-color"];if(i+="."+e+a+"{",1==_&&y&&(i+="background-color: "+ot.getGlobalColorValue(y)+";",i+="border: 1px solid "+ot.getGlobalColorValue(y)+";",b&&(i+="color: "+ot.getGlobalColorValue(b)+";")),2==_&&(i+="background-color: transparent;",y&&(i+="border: 1px solid "+ot.getGlobalColorValue(y)+";",i+="color: "+ot.getGlobalColorValue(y)+";")),h){var x=2==_?1:0;i+="padding: "+(parseInt(h)-x)+"px "+(1.6*parseInt(h)-x)+"px;"}i+="}"}var S=!1;if(ot.classes[e])for(paramName in ot.classes[e].original)0===paramName.indexOf("testimonial_")&&(S=!0);if(!o&&S){S=!1;var f,v,C,w,k="",P=c.testimonial_image_spacing;if("vertical"==c.testimonial_layout?(k="margin:0;",P=c.testimonial_image_spacing||ot.defaultOptions.oxy_testimonial.testimonial_image_spacing+ot.defaultOptions.oxy_testimonial["testimonial_image_spacing-unit"],"bottom"==c.testimonial_image_position?k+="margin-top":k+="margin-bottom"):"bottom"==c.testimonial_image_position?(k="margin:0;",P=c.testimonial_image_spacing||ot.defaultOptions.oxy_testimonial.testimonial_image_spacing+ot.defaultOptions.oxy_testimonial["testimonial_image_spacing-unit"],k+="margin-left"):k+="margin-right",k+=": "+P+";","left"==c.testimonial_content_alignment?(f="flex-start",v="left"):"center"==c.testimonial_content_alignment?v=f="center":"right"==c.testimonial_content_alignment&&(f="flex-end",v="right"),"left"==ot.classes[e].original.testimonial_mobile_content_alignment?(C="flex-start",w="left"):"center"==ot.classes[e].original.testimonial_mobile_content_alignment?w=C="center":"right"==ot.classes[e].original.testimonial_mobile_content_alignment&&(C="flex-end",w="right"),"vertical"==c.testimonial_layout?i+="."+e+a+" {flex-direction: column;}":"horizontal"==c.testimonial_layout&&(i+="."+e+a+" {flex-direction: row;align-items: center;}"),"top"==c.testimonial_image_position||""==c.testimonial_image_position?i+="."+e+a+" .oxy-testimonial-photo-wrap {order: 1;}":"bottom"==c.testimonial_image_position&&(i+="."+e+a+" .oxy-testimonial-photo-wrap {order: 3;}"),i+="."+e+a+" .oxy-testimonial-photo {width:"+c.testimonial_image_size+";height:"+c.testimonial_image_size+";"+k+"}",i+="."+e+a+" .oxy-testimonial-photo-wrap,."+e+a+" .oxy-testimonial-author-wrap,."+e+a+" .oxy-testimonial-content-wrap {align-items:"+f+";text-align:"+v+";}",i+="."+e+a+" .oxy-testimonial-text {margin-bottom:"+c.testimonial_text_space_below+";"+ot.generateTypographyCSS(c,"testimonial_text_typography")+"}",i+="."+e+a+" .oxy-testimonial-author {margin-bottom:"+c.testimonial_author_space_below+";"+ot.generateTypographyCSS(c,"testimonial_author_typography")+"}",i+="."+e+a+" .oxy-testimonial-author-info {margin-bottom:"+c.testimonial_author_info_space_below+";"+ot.generateTypographyCSS(c,"testimonial_author_info_typography")+"}",I=ot.getMediaMaxSize(ot.classes[e].original.testimonial_vertical_layout_below)){var O=c.testimonial_image_spacing;O||(O=ot.defaultOptions.oxy_testimonial.testimonial_image_spacing+ot.defaultOptions.oxy_testimonial["testimonial_image_spacing-unit"]),i+="@media (max-width: "+I+"){."+e+a+" {flex-direction: column !important;}."+e+a+" .oxy-testimonial-photo {margin: 0;margin-"+("bottom"==c.testimonial_image_position?"top":"bottom")+":"+O+";}."+e+a+" .oxy-testimonial-photo-wrap, ."+e+a+" .oxy-testimonial-author-wrap, ."+e+a+" .oxy-testimonial-content-wrap {align-items:"+C+";text-align:"+w+";}}"}}var z=!1;if(ot.classes[e])for(paramName in ot.classes[e].original)0===paramName.indexOf("icon_box_")&&(z=!0);if(!o&&z){var T,G,M,V,A,I;if(z=!1,"top"==c.icon_box_icon_position?T="column":"left"==c.icon_box_icon_position?T="row":"right"==c.icon_box_icon_position?T="row-reverse":"bottom"==c.icon_box_icon_position&&(T="column-reverse"),"left"==c.icon_box_icon_position||"right"==c.icon_box_icon_position){var E=c.icon_box_icon_space_before||ot.defaultOptions.oxy_icon_box.icon_box_icon_space_before+ot.defaultOptions.oxy_icon_box["icon_box_icon_space_before-unit"];right=c.icon_box_icon_space_after||ot.defaultOptions.oxy_icon_box.icon_box_icon_space_after+ot.defaultOptions.oxy_icon_box["icon_box_icon_space_after-unit"],M="margin-left: "+E+";\n",M+="margin-right: "+right+";\n",M+="margin-bottom: 0; margin-top: 0;"}else M="margin-top: "+c.icon_box_icon_space_before+";\n",M+="margin-bottom: "+c.icon_box_icon_space_after+";\n";"left"==c.icon_box_icon_position||"right"==c.icon_box_icon_position?G=c.icon_box_icon_vertical_alignment:"left"==c.icon_box_content_alignment?G="flex-start":"center"==c.icon_box_content_alignment?G="center":"right"==c.icon_box_content_alignment&&(G="flex-end"),A="left"==c.icon_box_mobile_content_alignment?(V="flex-start","left"):"center"==c.icon_box_mobile_content_alignment?V="center":"right"==c.icon_box_mobile_content_alignment?(V="flex-end","right"):(V="flex-start","left"),i+="."+e+a+" {text-align: "+c.icon_box_content_alignment+";flex-direction: "+T+";}",i+="."+e+a+" .oxy-icon-box-icon {"+M+"align-self: "+G+";}",i+="."+e+a+" .oxy-icon-box-heading {"+ot.generateTypographyCSS(c,"icon_box_heading_typography")+"margin-top: "+c.icon_box_heading_space_above+";margin-bottom: "+c.icon_box_heading_space_below+";}",i+="."+e+a+" .oxy-icon-box-text {"+ot.generateTypographyCSS(c,"icon_box_text_typography")+"margin-top: "+c.icon_box_text_space_above+";margin-bottom: "+c.icon_box_text_space_below+";align-self: "+G+";}",i+="."+e+a+" .oxy-icon-box-link {margin-top: "+c.icon_box_link_space_above+";margin-bottom: "+c.icon_box_link_space_below+";}",(I=ot.getMediaMaxSize(ot.classes[e].original.icon_box_vertical_layout_below))&&!r&&(i+="@media (max-width: "+I+"){."+e+a+".oxy-icon-box {flex-direction: column !important;text-align: "+A+";}."+e+a+" .oxy-icon-box-icon {margin-left: 0;margin-right: 0;margin-top: "+c.icon_box_icon_space_before+";margin-bottom: "+c.icon_box_icon_space_after+";}."+e+a+" .oxy-icon-box-icon, .oxy-icon-box-text {align-self: "+V+";}}")}var F=!1;if(ot.classes[e])for(paramName in ot.classes[e].original)0===paramName.indexOf("progress_bar_")&&(F=!0);if(!o&&F){F=!1;var N="",j=[];if("true"==c.progress_bar_stripes&&(N="background-image: linear-gradient(-45deg,rgba(255,255,255,.12) 25%,transparent 25%,transparent 50%,rgba(255,255,255,.12) 50%,rgba(255,255,255,.12) 75%,transparent 75%,transparent);"),"false"==c.progress_bar_stripes&&(N="background-image:none;"),"true"==c.progress_bar_animation_stripes){var K=c.progress_bar_animation_stripes_duration||ot.defaultOptions.oxy_progress_bar.progress_bar_animation_stripes_duration;j.stripes="oxy_progress_bar_stripes "+K+" linear infinite"}if("false"==c.progress_bar_animation_stripes&&(j.stripes="none 0s paused"),"true"==c.progress_bar_animate_width){var B=c.progress_bar_animation_width_duration||ot.defaultOptions.oxy_progress_bar.progress_bar_animation_width_duration;j.width="oxy_progress_bar_width "+B+" ease-out 1"}"false"==c.progress_bar_animate_width&&(j.width="none 0s paused");var D=[];for(var H in j)D.push(j[H]);i+="."+e+a+" .oxy-progress-bar-background {background-color:"+ot.getGlobalColorValue(c.progress_bar_background_color)+";"+N+"animation:"+j.stripes+";}",i+="."+e+a+" .oxy-progress-bar-progress-wrap {width:"+c.progress_bar_progress+";}",i+="."+e+a+" .oxy-progress-bar-progress {background-color:"+ot.getGlobalColorValue(c.progress_bar_bar_color)+";padding:"+c.progress_bar_bar_padding+";"+N+"animation:"+D.join()+";}",i+="."+e+a+" .oxy-progress-bar-overlay-text {"+ot.generateTypographyCSS(c,"progress_bar_left_text_typography")+"}",i+="."+e+a+" .oxy-progress-bar-overlay-percent {"+ot.generateTypographyCSS(c,"progress_bar_right_text_typography")+"}"}var W,X,Y,U,L,$,Z=!1;if(ot.classes[e])for(paramName in ot.classes[e].original)0===paramName.indexOf("pricing_box_")&&(Z=!0);if(!o&&Z)Z=!1,"vertical"==c.pricing_box_price_layout?(X="column","left"==c.pricing_box_price_alignment?W="flex-start":"center"==c.pricing_box_price_alignment?W="center":"right"==c.pricing_box_price_alignment&&(W="flex-end")):"horizontal"==c.pricing_box_price_layout&&(X="row"),"horizontal"==c.pricing_box_price_layout&&("left"==c.pricing_box_price_alignment?Y="flex-start":"center"==c.pricing_box_price_alignment?Y="center":"right"==c.pricing_box_price_alignment&&(Y="flex-end")),"left"==c.pricing_box_global_alignment?U="flex-start":"center"==c.pricing_box_global_alignment?U="center":"right"==c.pricing_box_global_alignment&&(U="flex-end"),"left"==c.pricing_box_graphic_alignment?L="flex-start":"center"==c.pricing_box_graphic_alignment?L="center":"right"==c.pricing_box_graphic_alignment?L="flex-end":U&&(L=U),"left"==c.pricing_box_cta_alignment?$="flex-start":"center"==c.pricing_box_cta_alignment?$="center":"right"==c.pricing_box_cta_alignment?$="flex-end":U&&($=U),i+="."+e+a+" .oxy-pricing-box-section {"+ot.generateArrayOptionsCSS(c,"pricing_box_global")+"text-align:"+c.pricing_box_global_alignment+";}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-price {justify-content:"+U+";}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-graphic {"+ot.generateArrayOptionsCSS(c,"pricing_box_graphic")+"background-color:"+ot.getGlobalColorValue(c.pricing_box_graphic_background)+";text-align:"+c.pricing_box_graphic_alignment+";justify-content:"+L+";}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-title {"+ot.generateArrayOptionsCSS(c,"pricing_box_title")+"text-align:"+c.pricing_box_title_alignment+";background-color:"+ot.getGlobalColorValue(c.pricing_box_title_background)+";}",i+="."+e+a+" .oxy-pricing-box-title-title {"+ot.generateTypographyCSS(c,"pricing_box_title_typography")+"}",i+="."+e+a+" .oxy-pricing-box-title-subtitle {"+ot.generateTypographyCSS(c,"pricing_box_subtitle_typography")+"}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-price {"+ot.generateArrayOptionsCSS(c,"pricing_box_price")+"text-align:"+c.pricing_box_price_alignment+";background-color:"+ot.getGlobalColorValue(c.pricing_box_price_background)+";flex-direction:"+X+";justify-content:"+Y+";align-items:"+W+";}",i+="."+e+a+" .oxy-pricing-box-currency {"+ot.generateTypographyCSS(c,"pricing_box_price_amount_currency_typography")+"}",i+="."+e+a+" .oxy-pricing-box-amount-main {"+ot.generateTypographyCSS(c,"pricing_box_price_amount_main_typography")+"}",i+="."+e+a+" .oxy-pricing-box-amount-decimal {"+ot.generateTypographyCSS(c,"pricing_box_price_amount_decimal_typography")+"}",i+="."+e+a+" .oxy-pricing-box-term {"+ot.generateTypographyCSS(c,"pricing_box_price_amount_term_typography")+"}",i+="."+e+a+" .oxy-pricing-box-sale-price {"+ot.generateTypographyCSS(c,"pricing_box_price_sale_typography")+"margin-bottom:"+c.pricing_box_price_sale_space_below+";}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-content {"+ot.generateArrayOptionsCSS(c,"pricing_box_content")+"background-color:"+ot.getGlobalColorValue(c.pricing_box_content_background)+";text-align:"+c.pricing_box_content_alignment+";"+ot.generateTypographyCSS(c,"pricing_box_content_typography")+"}",i+="."+e+a+" .oxy-pricing-box-section.oxy-pricing-box-cta {"+ot.generateArrayOptionsCSS(c,"pricing_box_cta")+"background-color:"+ot.getGlobalColorValue(c.pricing_box_cta_background)+";text-align:"+c.pricing_box_cta_alignment+";justify-content:"+$+";}";!o&&ot.classHasOptions(e,"slider-")&&(r||"original"!=n||(c["slider-arrow-color"]&&"lighter"==c["slider-arrow-color"]&&(i+="."+e+" .unslider-arrow {",i+="background-color: rgba(255,255,255,0.2); ",i+="}"),c["slider-dot-color"]&&(i+="."+e+" .unslider-nav ol li {",i+="border-color: "+ot.getGlobalColorValue(c["slider-dot-color"])+"; ",i+="}",i+="."+e+" .unslider-nav ol li.unslider-active {",i+="background-color: "+ot.getGlobalColorValue(c["slider-dot-color"])+"; ",i+="}"),c["slider-remove-padding"]&&"yes"==c["slider-remove-padding"]&&(i+="."+e+" .unslider {",i+="padding: 0px; ",i+="}",i+="."+e+" .unslider-wrap.unslider-carousel > li {",i+="padding: 0px; ",i+="}",i+="."+e+" .unslider-arrow.next {",i+="right: 10px; ",i+="z-index: 100; ",i+="}",i+="."+e+" .unslider-arrow.prev {",i+="left: 10px; ",i+="z-index: 100; ",i+="}"),c["slider-dots-overlay"]&&"yes"==c["slider-dots-overlay"]&&(i+="."+e+" .unslider .unslider-nav {",i+="position: absolute; bottom: 0; left: 0; right: 0; z-index: 100",i+="}"),c["slider-stretch-slides"]&&"yes"==c["slider-stretch-slides"]&&(i+="."+e+" .unslider-wrap {",i+="display: flex;",i+="}",i+="."+e+" .ct-slide {",i+="height: 100%;",i+="}",i+="."+e+" .unslider,",i+="."+e+" .oxygen-unslider-container,",i+="."+e+" .unslider-wrap,",i+="."+e+" .unslider-wrap li {",i+="height: 100%;",i+="}"),c["slider-stretch-slides"]&&"yes"==c["slider-stretch-slides"]&&c["slider-animation"]&&"fade"==c["slider-animation"]&&(i+="."+e+" .unslider-fade ul li.unslider-active {",i+="width: 100%;",i+="}"),c["slider-slide-padding"]&&(i+="."+e+" .ct-slide {",i+="padding: "+c["slider-slide-padding"],i+="}")));var Q=!1;if(ot.classes[e])for(paramName in ot.classes[e].original)0===paramName.indexOf("toggle_")&&(Q=!0);!o&&Q&&(i+="."+e+a+" .oxy-expand-collapse-icon {font-size:"+c.toggle_icon_size+";}",i+="."+e+a+" .oxy-expand-collapse-icon::before,."+e+a+" .oxy-expand-collapse-icon::after {background-color:"+ot.getGlobalColorValue(c.toggle_icon_color)+";}");var q=!1;if(ot.classes[e])for(paramName in ot.classes[e].original)0===paramName.indexOf("superbox_")&&(q=!0);if(!o&&q){var R,J,ee,te,oe,re=c.superbox_secondary_scale_start,ae=c.superbox_secondary_scale_finish,ie=c.superbox_primary_scale_start,ne=c.superbox_primary_scale_finish,se="",le="",ce="",pe="";void 0!==re&&(J="transform: scale("+re+");"),void 0!==ae&&(ee="transform: scale("+ae+");"),void 0!==ie&&(te="transform: scale("+ie+");"),void 0!==ne&&(oe="transform: scale("+ne+");"),c.superbox_secondary_slide_direction&&(R=ot.slide_position(c.superbox_secondary_slide_direction,(c.superbox_secondary_slide_distance||"")+"px"),"in"==c.superbox_secondary_slide_inorout?(se=R.out_css,le=R.in_css):"out"==c.superbox_secondary_slide_inorout&&(se=R.in_css,le=R.out_css)),c.superbox_primary_slide_direction&&(R=ot.slide_position(c.superbox_primary_slide_direction,(c.superbox_primary_slide_distance||"")+"px"),"in"==c.superbox_primary_slide_inorout?(ce=R.out_css,pe=R.in_css):"out"==c.superbox_primary_slide_inorout&&(ce=R.in_css,pe=R.out_css)),i+="."+e+" .oxy-superbox-secondary, ."+e+" .oxy-superbox-primary {transition-duration:"+c.superbox_transition_duration+";}",i+="."+e+" .oxy-superbox-secondary {opacity:"+c.superbox_secondary_opacity_start+";"+se+J+"}",i+="."+e+":hover .oxy-superbox-secondary {opacity:"+c.superbox_secondary_opacity_finish+";z-index: 2147483642;"+le+ee+"}",i+="."+e+" .oxy-superbox-primary {opacity:"+c.superbox_primary_opacity_start+";"+ce+te+"}",i+="."+e+":hover .oxy-superbox-primary {opacity:"+c.superbox_primary_opacity_finish+";"+pe+oe+"}"}if(void 0!==ot.componentsTemplates)for(var de in ot.componentsTemplates)if(ot.componentsTemplates.hasOwnProperty(de)){var ge=!1;if(ot.classes[e])for(paramName in ot.classes[e][n])0===paramName.indexOf(de)&&(ge=!0);if(!o&&ge&&ot.componentsTemplates[de].registeredSelectors){var me=ot.componentsTemplates[de].registeredSelectors;for(var H in selectorsCSS="",me)if(me.hasOwnProperty(H)){var ue=me[H],_e="";if(ue)for(var ye in ue)ue.hasOwnProperty(ye)&&c[ue[ye]]&&(_e+=ye+":"+ot.getGlobalColorValue(c[ue[ye]])+";");_e&&(selectorsCSS+="."+e+" "+H+a+"{"+_e+"}")}i+=selectorsCSS}}if(c&&void 0!==ot.componentsTemplates)for(var de in ot.componentsTemplates)if(ot.componentsTemplates.hasOwnProperty(de)){var he=ot.componentsTemplates[de].valuesCSS;for(var be in he)if(he.hasOwnProperty(be)&&he[be][c[be]]){var xe=he[be][c[be]];i+=ot.prefixCSSSelectors(xe,e,!0)}}if(c["box-shadow-color"]){var Se="inset"==c["box-shadow-inset"]?c["box-shadow-inset"]+" ":"",fe=c["box-shadow-horizontal-offset"]?c["box-shadow-horizontal-offset"]+"px ":"",ve=c["box-shadow-vertical-offset"]?c["box-shadow-vertical-offset"]+"px ":"",Ce=c["box-shadow-blur"]?c["box-shadow-blur"]+"px ":"0px ",we=c["box-shadow-spread"]?c["box-shadow-spread"]+"px ":"";c["box-shadow"]=Se+fe+ve+Ce+we+ot.getGlobalColorValue(c["box-shadow-color"])}if(c["text-shadow-color"]){fe=c["text-shadow-horizontal-offset"]?c["text-shadow-horizontal-offset"]+"px ":"",ve=c["text-shadow-vertical-offset"]?c["text-shadow-vertical-offset"]+"px ":"",Ce=c["text-shadow-blur"]?c["text-shadow-blur"]+"px ":"0px ";c["text-shadow"]=fe+ve+Ce+ot.getGlobalColorValue(c["text-shadow-color"])}for(var ke in o?e.indexOf(".")<0&&e.indexOf("#")<0&&e.indexOf("body")<0?i+=".oxygen-body "+e+a:i+=e+a:i+="."+e+a,i+="{",i+=ot.getBackgroundLayersCSS(c,null,o,e,r,n)||"",i+=ot.getTransformCSS(c)||"",c)if(c.hasOwnProperty(ke)){if("custom-css"==ke)continue;if(0<=["display","flex-direction","flex-wrap","align-items","align-content","justify-content","gap"].indexOf(ke)&&!o)continue;var Pe=c[ke];if("flex-direction"==ke){i+=ke+":"+Pe+(Ve="reverse"==c["flex-reverse"]?"-reverse":"")+";";continue}if("filter"==ke&&c["filter-amount-"+Pe])Pe+="("+c["filter-amount-"+Pe]+")";else if("filter"==ke)continue;if(ot.fixUnits&&r&&-1==ke.indexOf("-unit")){var Oe=ke+"-unit",ze=s[ke],Te=s[Oe],Ge=ot.getClosestBreakpointValue(Oe,r,{class:e,state:n}),Me=ot.defaultOptions.all[Oe];-1<Oe.indexOf("container-padding")&&(Me=ot.globalSettings.sections[Oe]),ze&&!Te&&Ge&&Me&&(console.log('"'+e+'" has "'+ke+'" with no unit on "'+r+'" breakpoint'),o?ot.customSelectors[e].media[r][n][Oe]=Me:ot.classes[e].media[r][n][Oe]=Me,console.log('"'+e+'" default "'+Me+'" unit added for "'+Oe+'"'),console.log("-------------------------"))}if("content"==ke.trim().toLowerCase()&&(Pe='"'+Pe.replace('"','\\"')+'"',ot.contentAdded[e+a]=!0),("font-family"==ke||-1<ke.indexOf("font-family"))&&void 0!==Pe&&(ot.loadWebFont(Pe),-1===Pe.indexOf(",")&&"inherit"!==Pe.toLowerCase()&&(Pe="'"+Pe+"'")),"background-image"==ke||"background-size"==ke)continue;Pe&&ot.excludeProperties.indexOf(ke)<0&&"background-layers"!==ke&&(i+=ke+":"+ot.getGlobalColorValue(Pe)+";"),"-webkit-font-smoothing"==ke&&(i+="-moz-osx-font-smoothing:"+("antialiased"===Pe?"grayscale":"unset")+";")}if("before"!=n&&"after"!=n||ot.contentAdded[e+a]||(i+='content:"";',ot.contentAdded[e+a]=!0),c["custom-css"]&&(i+=ot.replaceGlobalColors(c["custom-css"])),i+="}",(c["container-padding-top"]||c["container-padding-right"]||c["container-padding-bottom"]||c["container-padding-left"])&&(i+="."+e+a+" .ct-section-inner-wrap {",c["container-padding-top"]&&(i+="padding-top:"+c["container-padding-top"]+";"),c["container-padding-right"]&&(i+="padding-right:"+c["container-padding-right"]+";"),c["container-padding-bottom"]&&(i+="padding-bottom:"+c["container-padding-bottom"]+";"),c["container-padding-left"]&&(i+="padding-left:"+c["container-padding-left"]+";"),i+="}"),(c.display||c["flex-direction"]||c["flex-wrap"]||c["align-items"]||c["align-content"]||c["justify-content"]||c.gap)&&!o){i+="."+e+":not(.ct-section)"+a,ot.isPseudoElement(a)?i+=",."+e+".ct-section .ct-section-inner-wrap"+a:i+=",."+e+".ct-section"+a+" .ct-section-inner-wrap",i+="{",c.display&&"grid"!=c["flex-direction"]&&(i+="display:"+c.display+";");var Ve="reverse"==c["flex-reverse"]?"-reverse":"";c["flex-direction"]&&"grid"!=c["flex-direction"]&&(i+="flex-direction:"+c["flex-direction"]+Ve+";"),c["justify-content"]&&(i+="justify-content:"+c["justify-content"]+";"),c["align-content"]&&(i+="align-content:"+c["align-content"]+";"),c["align-items"]&&(i+="align-items:"+c["align-items"]+";"),c["flex-wrap"]&&(i+="flex-wrap:"+c["flex-wrap"]+";"),c.gap&&(i+="gap:"+c.gap+";"),i+="}"}if("grid"==c.display){var Ae=ot.getGridCSS(c,void 0,"forceDisplayGrid")||"";Ae&&(i+="."+e+":not(.ct-section):not(.oxy-easy-posts)"+a,ot.isPseudoElement(a)?(i+=",."+e+".oxy-easy-posts .oxy-posts"+a,i+=",."+e+".ct-section .ct-section-inner-wrap"+a):(i+=",."+e+".oxy-easy-posts"+a+" .oxy-posts",i+=",."+e+".ct-section"+a+" .ct-section-inner-wrap"),i+="{",i+=Ae,i+="}"),i+=ot.getGridChildCSS(c,e,a,!1,"is class")}}return i},ot.generateTreeCSS=function(t,o,r,a){if(a=0,a++,"[object Array]"!==Object.prototype.toString.call(t))return!1;ot.log&&console.log("generateTreeCSS()",t,o),angular.forEach(t,function(e){e.options.name=e.name,e.options.original,e.options.id=e.options.original,ot.generateDynamicBackgrounds(e.id,!1,"id",function(){o.styles+=ot.getSingleComponentCSS(e.options,e.id),e.children?ot.generateTreeCSS(e.children,o,r,a):a<=1&&r&&r()},{children:t})}),a--},ot.classHasOptions=function(e,t){if(ot.classes[e])for(paramName in ot.classes[e].original)if(0===paramName.indexOf(t))return!0},ot.classHasOption=function(e){var t=ot.componentsClasses[ot.component.active.id];if(null!=t)for(i in t){var o=t[i];for(stateKey in ot.classes[o])if("media"!=stateKey&&"parent"!=stateKey){var r=ot.classes[o][stateKey];if(-1<e.indexOf(".")){if(2==(e=e.split(".")).length&&r[e[0]]&&r[e[0]][e[1]])return!0;if(3==e.length&&r[e[0]]&&r[e[0]][e[1]]&&r[e[0]][e[1]][e[2]])return!0}else if(r[e])return!0}if(!ot.isEditing("media"))return!1;if(ot.classes[o].media){var a=ot.sortedMediaList();for(var i in a)if(a.hasOwnProperty(i)){var n=a[i];if("default"==n)continue;if(ot.classes[o].media[n]){var s=ot.classes[o].media[n];for(stateKey in s){r=s[stateKey];if(-1<e.indexOf(".")){if(2==(e=e.split(".")).length&&r[e[0]]&&r[e[0]][e[1]])return!0;if(3==e.length&&r[e[0]]&&r[e[0]][e[1]]&&r[e[0]][e[1]][e[2]])return!0}else if(r[e])return!0}}if(n==ot.getCurrentMedia())return!1}}}},ot.classHasOptionEqualTo=function(e,t){var o=ot.componentsClasses[ot.component.active.id];if(null!=o)for(key in o){var r=o[key];if(ot.classes[r].media)for(mediaKey in ot.classes[r].media){var a=ot.classes[r].media[mediaKey];for(stateKey in a){var i=a[stateKey];if(-1<e.indexOf(".")){if(2==(e=e.split(".")).length&&i[e[0]]&&i[e[0]][e[1]]&&i[e[0]][e[1]]==t)return!0;if(3==e.length&&i[e[0]]&&i[e[0]][e[1]]&&i[e[0]][e[1]][e[2]]&&i[e[0]][e[1]][e[2]]==t)return!0}else if(i[e])return!0}}for(stateKey in ot.classes[r])if("media"!=stateKey&&"parent"!=stateKey){i=ot.classes[r][stateKey];if(-1<e.indexOf(".")){if(2==(e=e.split(".")).length&&i[e[0]]&&i[e[0]][e[1]]&&i[e[0]][e[1]]==t)return!0;if(3==e.length&&i[e[0]]&&i[e[0]][e[1]]&&i[e[0]][e[1]][e[2]]&&i[e[0]][e[1]][e[2]]==t)return!0}else if(i[e]&&i[e]==t)return!0}}},ot.IDHasOption=function(e){var t=ot.component.active.id;for(stateKey in ot.component.options[t])if("media"!=stateKey&&"model"!=stateKey&&"original"!=stateKey){var o=ot.component.options[t][stateKey]||[];if(-1<e.indexOf(".")){if(2==(e=e.split(".")).length&&o[e[0]]&&o[e[0]][e[1]])return!0;if(3==e.length&&o[e[0]]&&o[e[0]][e[1]]&&o[e[0]][e[1]][e[2]])return!0}else if(o[e])return!0}if(!ot.isEditing("media"))return!1;if(ot.component.options[t].media){var r=ot.sortedMediaList();for(var a in r)if(r.hasOwnProperty(a)){var i=r[a];if("default"==i)continue;if(ot.component.options[t].media[i]){var n=ot.component.options[t].media[i];for(stateKey in n){o=n[stateKey];if(-1<e.indexOf(".")){if(2==(e=e.split(".")).length&&o[e[0]]&&o[e[0]][e[1]])return!0;if(3==e.length&&o[e[0]]&&o[e[0]][e[1]]&&o[e[0]][e[1]][e[2]])return!0}else if(o[e])return!0}}if(i==ot.getCurrentMedia())return!1}}},ot.IDHasOptionEqualTo=function(e,t){var o=ot.component.active.id;if(ot.component.options[o].media)for(mediaKey in ot.component.options[o].media){var r=ot.component.options[o].media[mediaKey];for(stateKey in r){var a=r[stateKey];if(-1<e.indexOf(".")){if(2==(e=e.split(".")).length&&a[e[0]]&&a[e[0]][e[1]]&&a[e[0]][e[1]]==t)return!0;if(3==e.length&&a[e[0]]&&a[e[0]][e[1]]&&a[e[0]][e[1]][e[2]]&&a[e[0]][e[1]][e[2]]==t)return!0}else if(a[e])return!0}}for(stateKey in ot.component.options[o])if("media"!=stateKey&&"model"!=stateKey&&"original"!=stateKey){a=ot.component.options[o][stateKey]||[];if(-1<e.indexOf(".")){if(2==(e=e.split(".")).length&&a[e[0]]&&a[e[0]][e[1]]&&a[e[0]][e[1]]==t)return!0;if(3==e.length&&a[e[0]]&&a[e[0]][e[1]]&&a[e[0]][e[1]][e[2]]&&a[e[0]][e[1]][e[2]]==t)return!0}else if(a[e]&&a[e]==t)return!0}},ot.applyComponentCSS=function(e,t){null==e&&(e=ot.component.active.id),null==t&&(t=ot.component.active.name),ot.setOption(e,t,"custom-css",!1,!1)},ot.applyStyleSheet=function(e){var t="\n"+ot.replaceGlobalColors(e.css)+"\n",o=document.getElementById("ct-style-sheet-"+e.name);if(null===o){var r=document.getElementsByClassName("ct-css-location"),a=angular.element(r[r.length-1]);(o=angular.element("<style>").attr("id","ct-style-sheet-"+e.name).addClass("ct-css-location")).insertAfter(a)}else o=angular.element(o);if(o.empty(),o.append(t),bracket=ot.bracketsFailed(t)){if("("==bracket||"{"==bracket)var i="closing";else i="opening";var n="Warning: there is no "+i+' bracket for "'+bracket+'" somewhere in your CSS. This may break page styling.';jQuery(".oxygen-code-error-container",s.oxygenUIElement).show().html(n)}else jQuery(".oxygen-code-error-container",s.oxygenUIElement).hide().html("");ot.unsavedChanges()},ot.addDesignSetStyleSheets=function(e){for(var t in e)if(e.hasOwnProperty(t)){var o=e[t];"object"==typeof o&&void 0===ot.styleSheets[o.name]&&(ot.styleSheets[o.name]=ot.stripSlashes(o.content),ot.applyStyleSheet(o.name))}},ot.getWidth=function(e){if(!e)return{value:"",unit:""};var t=parseInt(e,10),o="";return t!==e&&(o=-1<e.indexOf("%")?"%":-1<e.indexOf("em")?"em":-1<e.indexOf("rem")?"rem":"px"),{value:t,unit:o}},ot.outputPageSettingsCSS=function(){var e="div.ct-section-inner-wrap, div.oxy-header-container{";e+="max-width:"+ot.getPageWidth()+"px;",e+="}",ot.getPageSetting("overlay-header-above")&&"never"!=ot.getPageSetting("overlay-header-above")&&("always"!=ot.getPageSetting("overlay-header-above")&&(e+="@media (min-width: "+ot.getMediaMinSize(ot.getPageSetting("overlay-header-above"))+") {"),e+="body.oxy-overlay-header .oxy-header {position: absolute;left: 0;right: 0;z-index: 2147483640;}body.oxy-overlay-header .oxy-header:not(.oxy-sticky-header-active),body.oxy-overlay-header .oxy-header:not(.oxy-sticky-header-active) .oxy-header-row {background-color: initial !important;}body.oxy-overlay-header .oxy-header .oxygen-hide-in-overlay{display: none;}body.oxy-overlay-header .oxy-header .oxygen-only-show-in-overlay{display: block;}","always"!=ot.getPageSetting("overlay-header-above")&&(e+="}")),ot.outputCSSStyles("ct-page-settings-styles",e)},ot.updateGlobalSettingsCSS=function(){var e="",t=ot.getGlobalFont("Text"),o=ot.getGlobalFont("Display");-1===t.indexOf(",")&&(t="'"+t+"'"),-1===o.indexOf(",")&&(o="'"+o+"'"),e+="body {",e+="font-family: "+t+";",e+="line-height: "+ot.globalSettings.body_text["line-height"]+";",e+="font-size: "+ot.globalSettings.body_text["font-size"]+ot.globalSettings.body_text["font-size-unit"]+";",e+="font-weight: "+ot.globalSettings.body_text["font-weight"]+";",e+="color: "+ot.getGlobalColorValue(ot.globalSettings.body_text.color)+";",e+="}",e+=".oxy-nav-menu-hamburger-line {",e+="background-color: "+ot.getGlobalColorValue(ot.globalSettings.body_text.color)+";",e+="}",e+="h1, h2, h3, h4, h5, h6 {",e+="font-family: "+o+";",""!==ot.globalSettings.headings.H1["font-size"]&&(e+="font-size: "+ot.globalSettings.headings.H1["font-size"]+ot.globalSettings.headings.H1["font-size-unit"]+";"),""!==ot.globalSettings.headings.H1["font-weight"]&&(e+="font-weight: "+ot.globalSettings.headings.H1["font-weight"]+";"),""!==ot.globalSettings.headings.H1["line-height"]&&(e+="line-height: "+ot.globalSettings.headings.H1["line-height"]+";"),""!==ot.globalSettings.headings.H1.color&&(e+="color: "+ot.getGlobalColorValue(ot.globalSettings.headings.H1.color)+";"),e+="}";var r="h2, h3, h4, h5, h6";for(var a in ot.globalSettings.headings)if(ot.globalSettings.headings.hasOwnProperty(a)){var i="";if("H1"==a)continue;""!==ot.globalSettings.headings[a]["font-size"]&&(i+="font-size: "+ot.globalSettings.headings[a]["font-size"]+ot.globalSettings.headings[a]["font-size-unit"]+";"),""!==ot.globalSettings.headings[a]["font-weight"]&&(i+="font-weight: "+ot.globalSettings.headings[a]["font-weight"]+";"),""!==ot.globalSettings.headings[a]["line-height"]&&(i+="line-height: "+ot.globalSettings.headings[a]["line-height"]+";"),""!==ot.globalSettings.headings[a].color&&(i+="color: "+ot.getGlobalColorValue(ot.globalSettings.headings[a].color)+";"),""!==i&&(e+=r+"{",e+=i,e+="}"),r=r.replace(a.toLowerCase()+", ","")}var n={all:"a",text_link:".ct-link-text",link_wrapper:".ct-link",button:".ct-link-button"};for(var s in n)if(n.hasOwnProperty(s)){var l="";r=n[s];ot.globalSettings.links[s]=ot.globalSettings.links[s]||{},""!==ot.globalSettings.links[s].color&&(l+="color: "+ot.getGlobalColorValue(ot.globalSettings.links[s].color)+";"),""!==ot.globalSettings.links[s]["font-weight"]&&(l+="font-weight: "+ot.globalSettings.links[s]["font-weight"]+";"),ot.globalSettings.links[s]["text-decoration"]&&(l+="text-decoration: "+ot.globalSettings.links[s]["text-decoration"]+";"),ot.globalSettings.links[s]["border-radius"]&&(l+="border-radius: "+ot.globalSettings.links[s]["border-radius"]+ot.globalSettings.links[s]["border-radius-unit"]+";"),""!==l&&(e+=r+" {",e+=l,e+="}"),(l="")!==ot.globalSettings.links[s].hover_color&&(l+="color: "+ot.getGlobalColorValue(ot.globalSettings.links[s].hover_color)+";"),ot.globalSettings.links[s]["hover_text-decoration"]&&(l+="text-decoration: "+ot.globalSettings.links[s]["hover_text-decoration"]+";"),""!==l&&(e+=r+":hover {",e+=l,e+="}")}for(var c in e+=".ct-section-inner-wrap {",e+="padding-top: "+ot.globalSettings.sections["container-padding-top"]+ot.globalSettings.sections["container-padding-top-unit"]+";",e+="padding-left: "+ot.globalSettings.sections["container-padding-left"]+ot.globalSettings.sections["container-padding-left-unit"]+";",e+="padding-right: "+ot.globalSettings.sections["container-padding-right"]+ot.globalSettings.sections["container-padding-right-unit"]+";",e+="padding-bottom: "+ot.globalSettings.sections["container-padding-bottom"]+ot.globalSettings.sections["container-padding-bottom-unit"]+";",e+="}",e+=".ct-new-columns > .ct-div-block {",e+="padding-top: "+ot.globalSettings.columns["padding-top"]+ot.globalSettings.columns["padding-top-unit"]+";",e+="padding-left: "+ot.globalSettings.columns["padding-left"]+ot.globalSettings.columns["padding-left-unit"]+";",e+="padding-right: "+ot.globalSettings.columns["padding-right"]+ot.globalSettings.columns["padding-right-unit"]+";",e+="padding-bottom: "+ot.globalSettings.columns["padding-bottom"]+ot.globalSettings.columns["padding-bottom-unit"]+";",e+="}",e+=".oxy-header-container {",e+="padding-left: "+ot.globalSettings.sections["container-padding-left"]+ot.globalSettings.sections["container-padding-left-unit"]+";",e+="padding-right: "+ot.globalSettings.sections["container-padding-right"]+ot.globalSettings.sections["container-padding-right-unit"]+";",e+="}",ot.globalSettings)if(ot.globalSettings.hasOwnProperty(c)){var p=ot.globalSettings[c];for(var d in p)p.hasOwnProperty(d)&&("font-family"==d||-1<d.indexOf("font-family"))&&ot.loadWebFont(p[d])}e+=ot.replaceGlobalWooSettings(CtBuilderAjax.wooGlobalStyles),ot.outputCSSStyles("oxygen-global-settings-styles",e)},ot.$watch("globalSettings",function(e,t){ot.updateGlobalSettingsCSS()},!0),ot.$watch("globalSettings.sections",function(e,t){ot.pageSettingsUpdate(),ot.applyModelOptions(),ot.unsavedChanges()},!0),ot.$watch("globalSettings.woo",function(e,t){ot.updateAllComponentsCacheStyles(),ot.outputCSSOptions()},!0),ot.$watch("pageSettingsMeta",function(e,t){ot.pageSettingsUpdate(),ot.unsavedChanges()},!0),ot.$watch("pageSettingsMeta.aos",function(e,t){ot.updateAOS()},!0),ot.updateAOS=function(){var e=angular.copy(ot.pageSettingsMeta.aos);for(var t in e)""!==e[t]&&void 0!==e[t]||delete e[t];var o=angular.extend({},ot.globalSettings.aos,e);for(var t in"false"===o.once&&(o.once=!1),e=o)""!==e[t]&&void 0!==e[t]||delete e[t];aosDefaults={offset:120,delay:0,easing:"ease",duration:400,disable:!1,once:!1},o=angular.extend({},aosDefaults,e),jQuery('[data-aos-enabled="true"]').each(function(){var e=jQuery(this).attr("ng-attr-component-id");ot.setOption(e,ot.component.options[e].name,"aos-type")}),AOS.init(o)},ot.bracketsFailed=function(e){return e=(""+e).replace(/(\/[*][^*]*[*]\/)|(\/\/[^\n]*)/gm,""),function(e){for(var t={"}":"{",")":"("},o=[],r=0,a=(e=""+e).length;r<a;r++)t[e[r]]&&o.pop()===t[e[r]]||o.push(e[r]);return!!o.length&&o[0]}(e=(""+e).replace(/[^(){}]/g,""))},ot.mapCSSProperty=function(e,t,o){ot.mappedSelectors[o]||(ot.mappedSelectors[o]={}),ot.mappedSelectors[o][t]||(ot.mappedSelectors[o][t]={}),ot.mappedSelectors[o][t]=e},ot.unmapCSSProperty=function(e,t){ot.mappedSelectors[t][e]=null,delete ot.mappedSelectors[t][e]},ot.getMappedCSS=function(t,e){var o="";for(var r in ot.mappedSelectors){var a=ot.mappedSelectors[r];for(var i in o+=(r=r.split(",").map(function(e){return"#"+t+" "+e}).join(","))+"{",a)if(void 0!==a[i]&&void 0!==e[a[i]]&&""!==e[a[i]].toString().trim()){var n="";void 0!==e[a[i]+"-unit"]&&(n=e[a[i]+"-unit"]),o+="background-image"===i?i+": url("+e[a[i]]+");":i+":"+ot.getGlobalColorValue(e[a[i]])+n+";"}o+="}"}return o},ot.generateAllAPISelectorsCSS=function(e,t,o){if(void 0===ot.componentsTemplates)return"";var r="";for(var a in ot.componentsTemplates)ot.componentsTemplates.hasOwnProperty(a)&&(r+=ot.generateAPISelectorsCSS(a,e,t,o));return r},ot.generateAPISelectorsCSS=function(e,t,o,r){if(void 0===ot.componentsTemplates[e]||void 0===ot.componentsTemplates[e].registeredSelectors)return"";var a="",i=ot.componentsTemplates[e].registeredSelectors,n=angular.copy(ot.componentsTemplates[e].complexProperties);for(var s in i)if(i.hasOwnProperty(s)){var l=i[s],c="";if(l){for(var p in l){if(l.hasOwnProperty(p)){if(!o)continue;if("typography"==p)c+=ot.generateTypographyCSS(o,l[p]);else if("box-shadow"==p)c+=ot.generateBoxShadowCSS(o,l[p]);else if(-1<p.indexOf(">")){var d=p.split(">");if(n&&n[d[0]]){var g=n[d[0]];n[d[0]]=g.replace("{"+d[1]+"}",o[l[p]])}}else if(o[l[p]]){g=ot.addFontFamilyQuotes(p,o[l[p]]);g=ot.getGlobalColorValue(g),"transform:rotate"==p&&(p="transform",g="rotate("+g+")"),"background-image:url"==p&&(p="background-image",g="url("+g+")"),c+=p+":"+g+";"}else{var m=[];for(var u in o)if(o.hasOwnProperty(u)&&-1<u.indexOf(l[p])){var _;_=u.replace(l[p]+"_","");g=ot.addFontFamilyQuotes(_,o[u]);m[_]=g}if(m["background-position-top"]||m["background-position-left"]){var y=m["background-position-top"]||"0%",h=m["background-position-left"]||"0%";m["background-position"]=h,m["background-position"]+=" "+y,delete m["background-position-top"],delete m["background-position-left"]}if("manual"==m["background-size"]){var b=m["background-size-width"]||"auto",x=m["background-size-height"]||"auto";m["background-size"]=b,m["background-size"]+=" "+x,delete m["background-size-width"],delete m["background-size-height"]}for(var u in m)if(m.hasOwnProperty(u)){g=m[u];"background-image"==u&&(g="url("+g+")"),c+=u+":"+ot.getGlobalColorValue(g)+";"}}}for(var p in n)if(n.hasOwnProperty(p)){if(-1<n[p].indexOf("{"))continue;c+=p+":"+ot.getGlobalColorValue(n[p])+";"}}c&&(c=s+"{"+c+"}",a+=ot.prefixCSSSelectors(c,t,r))}}return a},ot.position_css=function(e,t){var o;for(var r in e){var a=e[r];!0===t&&null!==a&&(a="0"),null!==a&&(o=r+":"+a+";")}return o},ot.slide_position=function(e,t){var o="100%",r=[],a=[];switch(void 0!==t&&"px"!==t&&(o=t),e){case"left":r.left="-"+o;break;case"right":r.left=""+o;break;case"top":r.top="-"+o;break;case"bottom":r.top=""+o}return a.out_css=ot.position_css(r),a.in_css=ot.position_css(r,!0),a},ot.SPECIFICITY=(o=function(e){var t,o,r,a,i=[];for(r=0,a=(t=e.split(",")).length;r<a;r+=1)0<(o=t[r]).length&&i.push(n(o));return i},n=function(l){var e,t,o,c=l,p={a:0,b:0,c:0},d=[];return e=function(e,t){var o,r,a,i,n,s;if(e.test(c))for(r=0,a=(o=c.match(e)).length;r<a;r+=1)p[t]+=1,i=o[r],n=c.indexOf(i),s=i.length,d.push({selector:l.substr(n,s),type:t,index:n,length:s}),c=c.replace(i,Array(s+1).join(" "))},(t=function(e){var t,o,r,a;if(e.test(c))for(o=0,r=(t=c.match(e)).length;o<r;o+=1)a=t[o],c=c.replace(a,Array(a.length+1).join("A"))})(/\\[0-9A-Fa-f]{6}\s?/g),t(/\\[0-9A-Fa-f]{1,5}\s/g),t(/\\./g),(o=/:not\(([^\)]*)\)/g).test(c)&&(c=c.replace(o,"     $1 ")),function(){var e,t,o,r,a=/{[^]*/gm;if(a.test(c))for(t=0,o=(e=c.match(a)).length;t<o;t+=1)r=e[t],c=c.replace(r,Array(r.length+1).join(" "))}(),e(/(\[[^\]]+\])/g,"b"),e(/(#[^\s\+>~\.\[:]+)/g,"a"),e(/(\.[^\s\+>~\.\[:]+)/g,"b"),e(/(::[^\s\+>~\.\[:]+|:first-line|:first-letter|:before|:after)/gi,"c"),e(/(:[\w-]+\([^\)]*\))/gi,"b"),e(/(:[^\s\+>~\.\[:]+)/g,"b"),c=(c=c.replace(/[\*\s\+>~]/g," ")).replace(/[#\.]/g," "),e(/([^\s\+>~\.\[:]+)/g,"c"),d.sort(function(e,t){return e.index-t.index}),{selector:l,specificity:"0,"+p.a.toString()+","+p.b.toString()+","+p.c.toString(),specificityArray:[0,p.a,p.b,p.c],parts:d}},{calculate:o,compare:function(e,t){var o,r,a;if("string"==typeof e){if(-1!==e.indexOf(","))throw"Invalid CSS selector";o=n(e).specificityArray}else{if(!Array.isArray(e))throw"Invalid CSS selector or specificity array";if(4!==e.filter(function(e){return"number"==typeof e}).length)throw"Invalid specificity array";o=e}if("string"==typeof t){if(-1!==t.indexOf(","))throw"Invalid CSS selector";r=n(t).specificityArray}else{if(!Array.isArray(t))throw"Invalid CSS selector or specificity array";if(4!==t.filter(function(e){return"number"==typeof e}).length)throw"Invalid specificity array";r=t}for(a=0;a<4;a+=1){if(o[a]<r[a])return-1;if(o[a]>r[a])return 1}return 0}})}]);
CTFrontendBuilder.controller("ControllerTemplates",["$scope","$parentScope","$timeout","$interval",function(m,u,f,e){m.replaceAfterReusable=!1,m.template={},m.template.postData={},m.componentizeOptions={},m.componentizeOptions.name="Re-usable component",m.componentizeOptions.pageName="Re-usable page",m.componentizeOptions.setName="My Design Set",m.componentizeOptions.status="public",m.previewType="",m.separatorAdded=!1,m.loadTemplatesTerm=function(e,o){m.previewType=o,m.loadTemplateData(m.setTemplateData,e)},m.setTemplateData=function(e){if(m.log&&console.log("setTemplateData()",e),void 0!==e.bodyClass&&jQuery("body").addClass(e.bodyClass).addClass("oxygen-builder-body"),void 0!==e.postData&&(m.template.postData=e.postData),void 0!==e.edit_link&&(m.template.postData.edit_link=e.edit_link),void 0!==e.postsList||void 0!==e.termsList){var o=!1;if(void 0!==e.postsList&&(null===e.postsList||(m.template.postsList=e.postsList,e.default?(m.loadTemplatesTerm(e.default.id,"post"),o=!0):e.postsList[0]&&(m.loadTemplatesTerm(e.postsList[0].id,"post"),o=!0))),void 0!==e.termsList&&e.termsList[0]&&(m.template.termsList=e.termsList,o||(m.loadTemplatesTerm(e.termsList[0].id,"term"),o=!0)),o)return}e.meta_keys&&(u.current_post_meta_keys=e.meta_keys),m.updateAttachmentSizes=!0,m.rebuildDOM(0),m.classesCached=!1,m.outputCSSOptions(),m.waitOxygenTree(function(){m.updateAttachmentSizes=!1})},m.loadReusablePart=function(e,o){void 0!==o?m.loadComponentsTree(m.addReusableChildren,e,o):m.loadComponentsTree(m.addReusable,e,o)},m.addReusable=function(e,o){var t={};t=void 0!==e[0]&&void 0!==e[0].content?e[0].content:e,m.log&&console.log("addReusable()",o);var n=m.component.active.id,i={id:0,name:"ct_reusable",options:{view_id:o}},s=m.getClosestPossibleInsert(n,t,m.replaceAfterReusable);m.componentBuffer=i,m.componentInsertId=s.id,0<=s.index&&(m.newComponentKey=s.index);var a=m.component.id;m.updateNewComponentIds(m.componentBuffer,s),m.findComponentItem(m.componentsTree.children,s.id,m.pasteComponentToTree),m.replaceAfterReusable&&(m.removeComponentById(m.replaceAfterReusable),m.replaceAfterReusable=!1),m.cancelDeleteUndo(),m.rebuildDOM(a),m.activateComponent(a);var r=f(function(){u.scrollToComponent(m.getActiveComponent().attr("id")),f.cancel(r)},0,!1);if(void 0!==oxygenVSBInitTabs)var c=f(function(){oxygenVSBInitTabs("#"+m.component.options[a].selector),f.cancel(c)},500,!1),l=f(function(){oxygenVSBInitTabs("#"+m.component.options[a].selector),f.cancel(l)},1500,!1);m.unsavedChanges()},m.recursively_find_reusable=function(e){_.forEach(e,function(e){if("ct_reusable"==e.name)e.options.view_id;e.children&&m.recursively_find_reusable(e.children)})},m.addPageFromSource=function(e,o,n){var i=m.component.active.id;i<0&&(iframeScope.activateComponent(0,"root"),i=0,iframeScope.currentClass=!1);var t=JSON.parse(e);if(!t||!t.components||t.components.length<1)m.showErrorModal(0,"Could not load the page. "+(t.error?t.error:"Try again!"));else{var s=!1,a=!1;if(t.components&&(s=t.components),s){t.classes&&(a=t.classes);var r={};t.colors&&(r=m.mergeIncomingSourceColors(t.colors,n));var c={};if(t.lookuptable&&(c=t.lookuptable),a){for(key in 0<Object.keys(r).length&&(a=m.ctMapSourceColors(a,r)),CtBuilderAjax.classicDesignsets.find(function(e){return e==n})&&(a=m.ctCreateVariableColors(a,n,c)),m.styleFolders.hasOwnProperty(n)||(m.styleFolders[n]={status:1,key:n}),a)a[key].parent=n;m.classes=Object.assign(a,m.classes),m.classesCached=!1}var l=m.component.id;_.each(s,function(e){var o=m.component.id;0<Object.keys(r).length&&(e=m.ctMapSourceColors(e,r)),CtBuilderAjax.classicDesignsets.find(function(e){return e==n})&&(e=m.ctCreateVariableColors(e,n,c));var t={id:0,index:iframeScope.getComponentById(i).index()+1};m.componentBuffer=e,0<=t.index&&(m.newComponentKey=t.index),m.updateNewComponentIds(m.componentBuffer,t),m.findComponentItem(m.componentsTree.children,t.id,m.pasteComponentToTree),m.cancelDeleteUndo(),m.rebuildDOM(o),m.updateComponentCacheStyles(o,function(){m.cache.idCSS="",Object.keys(m.cache.idStyles).map(function(e,o){m.cache.idCSS+=m.cache.idStyles[e]}),m.outputCSSStylesAfterWait("id",m.cache.idCSS)}),i=o}),m.rebuildDOM(0),m.outputCSSOptions(),m.activateComponent(l);var d=f(function(){u.scrollToComponent(m.getActiveComponent().attr("id")),f.cancel(d)},0,!1)}else m.showErrorModal(0,"Page not loaded, try again")}},m.ctMapSourceColors=function(e,t){for(key in e)"string"==typeof e[key]?e[key]=e[key].replace(/color\((\d*)\)/g,function(e,o){return"color("+t[parseInt(o)]+")"}):(e[key]instanceof Array||e[key]instanceof Object)&&(e[key]=m.ctMapSourceColors(e[key],t));return e},m.ctCreateVariableColorsCallback=function(e,o,t){var n=_.findWhere(iframeScope.globalColorSets.sets,{name:o});void 0===n&&(n={id:++iframeScope.globalColorSets.setsIncrement,name:o},iframeScope.globalColorSets.sets.push(n));var i,s=e.toLowerCase(),a=!1;t[s]?a=t[s]:t[s.replace(/ /g,"")]&&(a=t[s.replace(/ /g,"")]),4===s.length&&(s="#"+s.substr(1).repeat(2),!1===a&&t[s]&&(a=t[s]));var r=!1;if(!1!==a&&(_.each(t,function(e,o){!1===r&&e==a&&(r=o),4===r.length&&(r="#"+r.substr(1).repeat(2))}),void 0!==(i=_.findWhere(iframeScope.globalColorSets.colors,{name:a,set:n.id}))&&r!==s&&(s=r,i.value=r)),void 0===i&&(i=_.findWhere(iframeScope.globalColorSets.colors,{sourceVal:s,set:n.id})),void 0===i){if("IGNORE"==a)return s;i={id:++iframeScope.globalColorSets.colorsIncrement,name:a||"color #"+iframeScope.globalColorSets.colorsIncrement,value:s,sourceVal:s,set:n.id},iframeScope.globalColorSets.colors.push(i)}return"color("+i.id+")"},m.ctCreateVariableColors=function(e,o,t){for(key in e)"string"==typeof e[key]?e[key]=e[key].replace(/#[0-9|a-f]{3,6}|rgba\([\d|\s]*\,[\d|\s]*\,[\d|\s]*\,[^\)]*\)/gi,function(e){return m.ctCreateVariableColorsCallback(e,o,t)}):(e[key]instanceof Array||e[key]instanceof Object)&&(e[key]=m.ctCreateVariableColors(e[key],o,t));var n=_.find(iframeScope.globalColorSets.sets,{name:o});if(void 0===n)return e;var i=[];return _.each(t,function(e){var o,t=_.find(iframeScope.globalColorSets.colors,{set:n.id,name:e});t&&(o=iframeScope.globalColorSets.colors.indexOf(t)),void 0!==o&&(i.push(t),iframeScope.globalColorSets.colors.splice(o,1))}),iframeScope.globalColorSets.colors=i.concat(iframeScope.globalColorSets.colors),e},m.mergeIncomingSourceColors=function(e,o){var t={},n=_.findWhere(iframeScope.globalColorSets.sets,{name:o});for(key in void 0===n&&(n={id:++iframeScope.globalColorSets.setsIncrement,name:o},iframeScope.globalColorSets.sets.push(n)),e){var i=_.findWhere(iframeScope.globalColorSets.colors,{name:e[key].name,set:n.id});t[parseInt(key)]=void 0!==i?parseInt(i.id):(iframeScope.globalColorSets.colors.push({id:++iframeScope.globalColorSets.colorsIncrement,name:e[key].name,value:e[key].value,set:n.id}),parseInt(iframeScope.globalColorSets.colorsIncrement))}return t},m.addComponentFromSource=function(e,o,t,n){null!=o&&o||(o=m.component.active.id),o<0&&(iframeScope.activateComponent(0,"root"),o=0,iframeScope.currentClass=!1);var i=JSON.parse(e);if(!i||!i.component||i.component.length<1)m.showErrorModal(0,"Could not load the component. "+(i.error?i.error:"Try again!"));else{var s=!1,a=!1;if(i.component&&(s=i.component),s){i.classes&&(a=i.classes);var r={};i.colors&&(r=m.mergeIncomingSourceColors(i.colors,n));var c={};i.lookuptable&&(c=i.lookuptable),0<Object.keys(r).length&&(s=m.ctMapSourceColors(s,r)),CtBuilderAjax.classicDesignsets.find(function(e){return e==n})&&(s=m.ctCreateVariableColors(s,n,c));var l=m.component.id,d=m.getClosestPossibleInsert(o,s);if(m.componentBuffer=s,0<=d.index&&(m.newComponentKey=d.index),a){for(key in 0<Object.keys(r).length&&(a=m.ctMapSourceColors(a,r)),CtBuilderAjax.classicDesignsets.find(function(e){return e==n})&&(a=m.ctCreateVariableColors(a,n,c)),n&&!m.styleFolders.hasOwnProperty(n)&&(m.styleFolders[n]={status:1,key:n}),a)a[key].parent=n;m.classes=Object.assign(a,m.classes),m.classesCached=!1}m.updateNewComponentIds(m.componentBuffer,d),m.findComponentItem(m.componentsTree.children,d.id,m.pasteComponentToTree),m.cancelDeleteUndo(),m.rebuildDOM(l),m.updateComponentCacheStyles(l,function(){m.cache.idCSS="",Object.keys(m.cache.idStyles).map(function(e,o){m.cache.idCSS+=m.cache.idStyles[e]}),m.outputCSSStylesAfterWait("id",m.cache.idCSS)}),m.outputCSSOptions(),m.activateComponent(l);var p=f(function(){u.scrollToComponent(m.getActiveComponent().attr("id")),f.cancel(p)},0,!1)}else m.showErrorModal(0,"Component not loaded, try again")}},m.addReusableChildren=function(e,o,t){null==t&&(t=m.component.active.id),m.log&&console.log("addReusableChildren()",e,o,t);var n={};void 0!==e[0]&&void 0!==e[0].content||(n=e);var i=m.getClosestPossibleInsert(t,n);m.addReusableChild(n.children,0,-1,i),m.newComponentKey=-1},m.addReusableChild=function(t,n,i,s){if(0==t.length){m.activateComponent(i);var e=f(function(){u.scrollToComponent(m.getActiveComponent().attr("id")),f.cancel(e)},0,!1);return m.outputCSSOptions(),void u.hideDialogWindow()}var o=m.component.id;if(i<0&&(i=o),m.componentBuffer=t[0],0<=s.index&&(m.newComponentKey=s.index+n),m.updateNewComponentIds(m.componentBuffer,s),m.findComponentItem(m.componentsTree.children,s.id,m.pasteComponentToTree),m.cancelDeleteUndo(),m.rebuildDOM(o),m.updateComponentCacheStyles(o,function(){m.cache.idCSS="",Object.keys(m.cache.idStyles).map(function(e,o){m.cache.idCSS+=m.cache.idStyles[e]}),m.outputCSSStylesAfterWait("id",m.cache.idCSS)}),void 0!==oxygenVSBInitTabs)var a=f(function(){oxygenVSBInitTabs("#"+m.component.options[o].selector),f.cancel(a)},500,!1),r=f(function(){oxygenVSBInitTabs("#"+m.component.options[o].selector),f.cancel(r)},1500,!1);function c(e){var o;0<m.buildingOxygenTreeCounter&&e<900?(o=e,o++,setTimeout(function(){c(o)},100)):m.addReusableChild(t.splice(1),n+1,i,s),0<m.buildingOxygenTreeCounter&&900<=e&&console.log("Tree building timeout. ID counter is not incremented.")}c(0)},m.addReusableContent=function(e,o){if(e){m.log&&console.log("addReusableContent()",e),e.edit_link&&(m.reusableEditLinks[o]=e.edit_link);var t=m.getComponentById(o);if(t){t.append(e.post_content);var n=jQuery(e.post_content);if(n){var s=[];for(n.attr("class")&&(s=n.attr("class").split(/\s+/)),i=0;i<s.length;++i)if(0<=s[i].indexOf("ct-")){var a=s[i].replace(/\-/g,"_");m.component.options[o].dndtype=a;break}}}m.reusableCSS={},m.reusableCSS.styles="",e.post_tree&&m.generateTreeCSS(e.post_tree,m.reusableCSS,function(){m.outputCSSStyles("ct-re-usable-styles-"+e.ID,m.reusableCSS.styles)})}},m.getClosestPossibleInsert=function(e,o,t){if(m.log&&console.log("getClosestPossibleInsert()",e,o),null==e)return{};var n=m.getComponentById(e);insertData={componentToInsertIn:n,componentInsertId:0,parentId:0,index:0<e?n.index()+1:-1},i=0;var s=insertData.componentToInsertIn[0].attributes["is-nestable"],a=insertData.componentToInsertIn[0].classList.contains("ct_reusable"),r=JSON.stringify(o),c=-1<r.indexOf('"name":"ct_section"'),l=-1<r.indexOf('"name":"ct_link"')||-1<r.indexOf('"name":"ct_link_text"');function d(e,o){for(var t=e.componentToInsertIn,n=e.parentId;!t.hasClass(o)&&!t.hasClass("ct-builder");)t=t.parent();e.parentId=t[0].getAttribute("ng-attr-component-id"),0!=e.parentId?(e.index=t.index()+1,e.componentToInsertIn=jQuery(t).parent().closest("[is-nestable]"),e.componentInsertId=e.componentToInsertIn[0].getAttribute("ng-attr-component-id")):e.parentId=n}if(c&&d(insertData,"ct_section"),l&&d(insertData,"ct_link"),0==insertData.parentId)if(!s||a||t)for(;(!s||t||a)&&i<10;)insertData.componentToInsertIn=jQuery(insertData.componentToInsertIn).parent().closest("[is-nestable]"),insertData.componentToInsertIn&&(s=insertData.componentToInsertIn[0].attributes["is-nestable"],a=insertData.componentToInsertIn[0].classList.contains("ct_reusable"),insertData.componentInsertId=insertData.componentToInsertIn[0].getAttribute("ng-attr-component-id")),s&&(t=!1),i++;else insertData.componentInsertId=e,insertData.index=-1;return{id:insertData.componentInsertId,index:insertData.index}},m.isCanComponentize=function(e,o){return!(-1<["ct_reusable","oxy_header_row","ct_slide","oxy_tab","oxy_tab_content"].indexOf(o))&&0<e},m.saveReusable=function(e,o){void 0===o&&(o=!1),m.cancelDeleteUndo(),void 0===e&&(e=m.component.active.id);var t=prompt(o?"New Block Name":"New Re-Usable Name",m.componentizeOptions.name);if(null!=t)if(u.showLoadingOverlay("saveReusable()"),m.componentizeOptions.name=t,m.isSelectableEnabled&&m.isDOMNodesSelected){var n=jQuery("#ct-dom-tree").find(".ct-selected-dom-node").first().parent().parent().children(".ct-dom-tree-node").has(".ct-selected-dom-node"),i=[];n.each(function(){i.push(jQuery(this).attr("ng-attr-tree-id"))}),m.selectedComponents=[];for(var s=0;e=i[s],s<=i.length-1;s++)m.findComponentItem(m.componentsTree.children,e,m.addSelectedComponent);m.saveComponentAsView(null,m.selectedComponents,o)}else m.findComponentItem(m.componentsTree.children,e,m.saveComponentAsView,o);else alert("Name can't be empty")},m.replaceReusablePart=function(e,o){m.replaceAfterReusable=e,m.loadReusablePart(o)},m.showComponentize=function(e){u.showDialogWindow(),m.componentizeOptions.id=e,u.dialogForms.showComponentizeForm=!0},m.componentize=function(){if(m.isSelectableEnabled&&m.isDOMNodesSelected){var e=jQuery("#ct-dom-tree").find(".ct-selected-dom-node").first().parent().parent().children(".ct-dom-tree-node").has(".ct-selected-dom-node"),o=[];e.each(function(){o.push(jQuery(this).attr("ng-attr-tree-id"))}),m.selectedComponents=[];for(var t,n=0;t=o[n],n<=o.length-1;n++)m.findComponentItem(m.componentsTree.children,t,m.addSelectedComponent);m.postComponentize(null,m.selectedComponents)}else 0<m.componentizeOptions.idToUpdate?(m.componentizeOptions.assetId=null,m.findComponentItem(m.componentsTree.children,m.componentizeOptions.id,m.postComponentize),m.componentizeOptions.id=null):m.postAsset(m.componentizeOptions.screenshot,function(){m.findComponentItem(m.componentsTree.children,m.componentizeOptions.id,m.postComponentize),m.componentizeOptions.id=null});u.hideDialogWindow()},m.showPageComponentize=function(e){u.showDialogWindow(),u.dialogForms.showPageComponentizeForm=!0},m.tryPageComponentize=function(){m.postAsset(m.componentizeOptions.screenshot,function(){m.pageComponentize()}),u.hideDialogWindow()},m.addSelectedComponent=function(e,o){m.selectedComponents.push(o)},m.addWidget=function(e,o,t){var n=m.component.id;m.addComponent("ct_widget","widget"),m.component.options[n].model.class_name=e,m.setOption(n,"ct_widget","class_name"),m.component.options[n].model.id_base=o,m.setOption(n,"ct_widget","id_base"),m.component.options[n].model.pretty_name=t,m.setOption(n,"ct_widget","pretty_name"),m.component.options[n].nicename=t+" (#"+n+")",m.updateFriendlyName(n)},m.addSidebar=function(e){var o=m.component.id;m.addComponent("ct_sidebar","sidebar"),m.setOptionModel("sidebar_id",e,o,"ct_sidebar"),m.rebuildDOM(o)},m.loadWidgetForm=function(){m.renderWidget(m.component.active.id,!0)},m.applyWidgetInstance=function(e){m.log&&console.log("applyWidgetInstance()",e),e||(e=m.component.active.id);var o=m.component.options[e];if("ct_widget"!=o.name)return!1;var c={},t=jQuery("#ct-widget-form",window.parent.document).serializeArray(),l=o.original.id_base,n=jQuery("#ct-widget-form input:checkbox",window.parent.document).map(function(){if(!this.checked)return{name:this.name,value:!!this.checked&&this.value}});for(i=0;i<n.length;i++)t.push(n[i]);jQuery.each(t,function(e,o){var t=o.name.replace(l,"");if(-1<(t=(t=t.replace(/widget-\[\d\]\[/,"")).replace("]","")).indexOf("[")){var n=t.replace(/\[(.*)\]/,""),i=[],s=t.replace(n,"").match(/\[[^\]]*\]/g),a=function(e,o,t,n){0==n.length?e[t]=o:(void 0===e[t]&&(e[t]={}),a(e[t],o,n.shift(),n))};for(j=0;j<s.length;j++)"[]"!=s[j]&&i.push(s[j].replace(/\[|\]/g,""));if(0<i.length){var r=i.slice();void 0===c[n]&&(c[n]={}),a(c[n],o.value,r.shift(),r)}else void 0===c[n]&&(c[n]=[]),c[n].push(o.value)}else""!==t&&(c[t]=o.value)}),m.component.options[m.component.active.id].model.instance=c,m.setOption(m.component.active.id,"ct_widget","instance"),m.renderWidget(m.component.active.id)},m.loadHTMLForm=function(){u.showDialogWindow(),angular.element("#ct-html-component-form").val(m.component.options[m.component.active.id].model.html)},m.applyCodeBlock=function(e,o){m.log&&console.log("applyCodeBlock()",e,o),m.applyCodeBlockPHP(e,o),m.applyCodeBlockJS(e,o),m.applyCodeBlockCSS(e,o)},m.applyCodeBlockPHP=function(e,o){void 0===e&&(e=m.component.active.id),void 0===o&&(o=!0),m.log&&console.log("applyCodeBlockPHP()",e),o&&m.setOption(e,"ct_code_block","code-php",!1,!1);var t="#"+m.component.options[e].selector,n=m.getOption("code-php",e);m.execCode(n,t,m.insertElementContent)},m.applyCodeBlockJS=function(e,o){m.applyingComponentJS=!0,jQuery(".oxygen-code-error-container",u.oxygenUIElement).hide().html(""),void 0===e&&(e=m.component.active.id),void 0===o&&(o=!0),m.log&&console.log("applyCodeBlockJS()",e,o),o&&m.setOption(e,"ct_code_block","code-js",!1,!1),code=m.getOption("code-js",e),m.outputJSScript("js-code-",e,code),m.applyingComponentJS=!1},m.applyCodeBlockCSS=function(e,o){void 0===e&&(e=m.component.active.id),void 0===o&&(o=!0),m.log&&console.log("applyCodeBlockCSS()",e,o),o&&m.setOption(e,"ct_code_block","code-css",!1,!1),code=m.getOption("code-css",e);var t=m.component.options[e].selector;code=code.replace(new RegExp("%%ELEMENT_ID%%","g"),t),code=m.replaceGlobalColors(code),m.outputCSSStyles("ct_code_block_css_"+e,code)},m.outputJSScript=function(e,o,t){m.log&&console.log("outputJSScript()",e,o);var n=m.component.options[o].selector;t=t.replace(new RegExp("%%ELEMENT_ID%%","g"),n);var i=document.getElementById(e+o);i&&document.body.removeChild(i);var s=document.createElement("script");s.type="text/javascript",s.setAttribute("id",e+o);try{s.appendChild(document.createTextNode(t)),document.body.appendChild(s)}catch(e){s.text=t,document.body.appendChild(s)}},m.setupJSErrorNotice=function(){window.onerror=function(e,o,t){if(m.applyingComponentJS)jQuery(".oxygen-code-error-container",u.oxygenUIElement).show().html(e+" on line #"+t);else{if("object"==typeof o)return;if(void 0!==o.indexOf&&-1<o.indexOf("/component-framework/vendor/aos/aos.js"))return;if(0<=e.indexOf("ResizeObserver loop limit exceeded"))return;if(m.isRenderingAJAXElement)return;for(var n=['name "wc-order-attribution-inputs" has already been used'],i=0;i<n.length;i++)if(-1!==e.indexOf(n[i]))return;m.showNoticeModal("<div>"+e+" on line #"+t+" in "+o+"</div>")}}},m.insertElementContent=function(e,o,t){m.log&&console.log("insertElementContent()",e,o);var n=angular.element(o);n.html(""),m.cleanInsert("<span class='removeOnInsert'>"+e+"</span>",n),m.adjustResizeBox()},m.getLinkId=function(e){void 0===e&&(e=m.component.active.id);var o=jQuery("[ng-attr-component-id='"+e+"']","#ct-builder").closest(".ct-links");return 0<o.length&&o.attr("ng-attr-component-id")},m.addSeparator=function(e){m.separatorAdded=!0},m.addComponentClassesStyles=function(e){if(e.options&&void 0!==e.options.classes)for(var o in m.classes)if(e.options&&-1<e.options.classes.indexOf(o)){var t=e.options.classes.indexOf(o);e.options.classes.splice(t,1),e.options.classes.push({name:o,styles:m.classes[o]})}for(var n in e.children)if(e.children.hasOwnProperty(n)){var i=e.children[n];m.addComponentClassesStyles(i)}},m.parseTreeClassesStyles=function(e){if(e.options&&void 0!==e.options.classes){for(var o in e.options.classes)if(e.options.classes.hasOwnProperty(o)&&null!=e.options.classes[o].name){var t=e.options.classes[o].name,n=e.options.classes[o].styles;e.options.classes[o]=t,void 0!==m.classes[t]||(m.classes[t]=n)}m.classesCached=!1,m.outputCSSOptions()}for(var o in e.children)if(e.children.hasOwnProperty(o)){var i=e.children[o];m.parseTreeClassesStyles(i)}}}]),function(e,t){if("function"==typeof define&&define.amd)define(["exports","jquery"],function(e,o){return t(e,o)});else if("undefined"!=typeof exports){var o=require("jquery");t(exports,o)}else t(e,e.jQuery||e.Zepto||e.ender||e.$)}(this,function(e,r){function o(n,t){function s(e,o,t){return e[o]=t,e}function e(){return i}var i={},a={};this.addPair=function(e){if(!c.validate.test(e.name))return this;var o=function(e,o){for(var t,n=e.match(c.key);void 0!==(t=n.pop());)c.push.test(t)?o=s([],(i=e.replace(/\[\]$/,""),void 0===a[i]&&(a[i]=0),a[i]++),o):c.fixed.test(t)?o=s([],t,o):c.named.test(t)&&(o=s({},t,o));var i;return o}(e.name,function(e){switch(r('[name="'+e.name+'"]',t).attr("type")){case"checkbox":return"on"===e.value||e.value;default:return e.value}}(e));return i=n.extend(!0,i,o),this},this.addPairs=function(e){if(!n.isArray(e))throw new Error("formSerializer.addPairs expects an Array");for(var o=0,t=e.length;o<t;o++)this.addPair(e[o]);return this},this.serialize=e,this.serializeJSON=function(){return JSON.stringify(e())}}var c={validate:/^[a-z_][a-z0-9_]*(?:\[(?:\d*|[a-z0-9_]+)\])*$/i,key:/[a-z0-9_]+|(?=\[\])/gi,push:/^$/,fixed:/^\d+$/,named:/^[a-z0-9_]+$/i};return o.patterns=c,o.serializeObject=function(){return new o(r,this).addPairs(this.serializeArray()).serialize()},o.serializeJSON=function(){return new o(r,this).addPairs(this.serializeArray()).serializeJSON()},void 0!==r.fn&&(r.fn.serializeObject=o.serializeObject,r.fn.serializeJSON=o.serializeJSON),e.FormSerializer=o});
...
CTFrontendBuilder.controller("ControllerShortcuts",["$scope","$parentScope","$timeout","$interval","$rootScope",function(c,n,r,e,s){var a,o,i,t=(a=function(e){if("true"==CtBuilderAjax.userCanFullAccess&&!e.originalEvent.repeat&&!n.isActiveActionTab("contentEditing")){var t=!1,a=e.key.toLowerCase();if(e.keyCode,!e.ctrlKey&&!e.metaKey||e.shiftKey){if((e.ctrlKey||e.metaKey)&&e.shiftKey)switch(a){case"c":n.copyElementExportJSON(n.iframeScope.component.active.id),t=!0;break;case"i":n.showImportModal(),t=!0;break;case"e":n.isActiveActionTab("componentBrowser")||n.switchActionTab("componentBrowser"),n.addSearchbarInputFocus=!1,n.showEmmetCLI=!0;var o=r(function(){n.emmetInputFocus=!0,r.cancel(o)},0,!1);break;case"a":n.isActiveActionTab("componentBrowser")||n.switchActionTab("componentBrowser"),n.emmetInputFocus=!1,n.showEmmetCLI=!1,o=r(function(){n.addSearchbarInputFocus=!0,r.cancel(o)},0,!1)}}else switch(a){case"s":iframeScope.savePage(),t=!0;break;case"backspace":case"delete":iframeScope.removeActiveComponent(),t=!0;break;case"d":iframeScope.duplicateComponent(),t=!0;break;case"c":console.log(c),console.log(s),s.$broadcast("copyElement"),t=!0;break;case"v":s.$broadcast("pasteElement"),t=!0;break;case"z":iframeScope.undo();break;case"y":iframeScope.redo()}return!t&&void 0}},o=250,function(){var e=this,t=arguments;i&&clearTimeout(i),i=setTimeout(function(){i=null,a.apply(e,t)},o)});function l(e){if(["s","backspace","delete","d","c","v","z","y","i","a","e"].includes(e.key.toLowerCase())&&(!e.target.parentElement.classList.contains("textarea")||"s"==e.key.toLowerCase())&&("INPUT"!=e.target.nodeName||"s"==e.key.toLowerCase()||e.target.classList.contains("oxygen-add-searchbar"))&&("TEXTAREA"!=e.target.nodeName||"s"==e.key.toLowerCase()||"oxy-emmet-cli-input"===e.target.getAttribute("id"))&&(!e.target.classList.contains("oxygen-add-searchbar")&&"oxy-emmet-cli-input"!=e.target.getAttribute("id")||!e.ctrlKey&&!e.metaKey||e.shiftKey||!["a","c","v"].includes(e.key.toLowerCase()))&&!(n.isActiveActionTab("contentEditing")||parent.document.getElementsByClassName("cm-focused").length&&"s"!=e.key.toLowerCase()))return e.ctrlKey||e.metaKey?(t(e),!1):void 0}angular.element("body").on("keydown",l),parent.angular.element("body").on("keydown",l)}]);
